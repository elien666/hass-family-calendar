...
export const WEBRTC_STATS_INTERVAL = 200      // Abfrageintervall für getStats() bis zum ersten Frame (blendet den Snapshot aus)
export const CAMERA_RETRY_INTERVAL = 30000    // fehlgeschlagene Kachel (WebRTC und MJPEG) erneut versuchen
