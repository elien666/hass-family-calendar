...
`,vt=({on:e,month:n,day:r})=>{const[s,a]=e,i=s.indexOf(`${n}-${r}`),c=i>-1,o=()=>{a(c?s.toSpliced(i,1):[...s,`${n}-${r}`])};return t.jsx("div",{className:j("dot",{on:c}),onClick:()=>o()})},wt=()=>{if(!Ae)return null;const e=new Date().getFullYear(),n=[];for(let o=1;o<13;o++){const u=new Date(e,o,0).getDate();for(let l=1;l<=u;l++)n.push({month:o,day:l})}const r=Array.from({length:31},(o,u)=>u+1),s=Array.from({length:12},(o,u)=>u+1),a=d.useState(void 0),[i,c]=xt();return d.useEffect(()=>{i!==null&&a[1](i)},[i]),d.useEffect(()=>{a[0]!==void 0&&yt(a[0])},[a[0]]),a[0]!==void 0?t.jsxs(Q,{children:[t.jsx("h2",{children:"Jeden Tag ein bißchen"}),c!==!1&&t.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center",marginBottom:"1rem"},children:[t.jsx("h3",{children:"Fehler!"}),t.jsx("div",{children:c instanceof Error?c.message:String(c)})]}),t.jsxs("div",{className:"calendar",children:[r.map((o,u)=>t.jsx("div",{style:{gridArea:`${o+1} / 1 / ${o+1} / 1`},children:o},u)),s.map((o,u)=>t.jsx("div",{style:{gridArea:`1 / ${o+1} / 1 / ${o+1}`},children:o},u)),n.map((o,u)=>t.jsx("div",{style:{gridArea:`${o.day+1} / ${o.month+1} / ${o.day+1} / ${o.month+1}`},children:t.jsx(vt,{on:a,month:o.month,day:o.day})},u))]})]}):t.jsx(Q,{className:"loading",children:c!==!1?t.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[t.jsx("h3",{children:"Fehler!"}),t.jsx("div",{children:c instanceof Error?c.message:String(c)})]}):t.jsx(le,{visible:!0,height:"80",width:"80",color:"#c1c1c1",radius:"9",ariaLabel:"three-dots-loading",wrapperStyle:{},wrapperClass:""})})},bt=b.div`
  ...
  }`,jt=()=>{const[e,n]=d.useState(y.now()),[r,s]=d.useState(!1),a=p.useCallback(()=>s(!0),[]),i=p.useCallback(()=>s(!1),[]);return d.useEffect(()=>{const c=setInterval(()=>n(y.now()),1e3);return()=>clearInterval(c)},[]),t.jsxs(t.Fragment,{children:[t.jsxs(bt,{onClick:a,children:[e.toFormat("HH"),t.jsx("span",{children:":"}),e.toFormat("mm")]}),t.jsx(I,{visible:r,onClick:i,fullsize:!0,children:t.jsx(wt,{})})]})},Et=p.memo(jt),B=_?k(`/api/states/${_}`):null,St=()=>{const[e,n]=d.useState("off"),[r,s]=d.useState(!1),a=Se&&_;return d.useEffect(()=>{!a||!B||w(B).then(i=>{n(i.data.state),s(!1)}).catch(i=>{s(C(i))})},[a,B]),d.useEffect(()=>{let i=null,c=!0;async function o(){if(!a||!_)return;let u;try{if(!me){v.debug("Skipping WebSocket connection in production mode (using REST API only)");return}const l=pe||(typeof window<"u"?window.location.origin:""),f=D||"";if(!f){v.debug("Skipping WebSocket connection - no access token (using REST API only)");return}u=fe(l,f),c&&s(!1)}catch(l){c&&(v.error("Failed to create WebSocket auth:",l),s(l instanceof Error?l.message:String(l)));return}try{i=await ue({auth:u});const l=f=>{c&&n(f.variables.trigger.to_state.state)};await i.subscribeMessage(l,{type:"subscribe_trigger",trigger:{platform:"state",entity_id:_}})}catch(l){c&&(v.error("Failed to setup WebSocket connection:",l),s(l instanceof Error?l.message:String(l)))}}return o(),()=>{c=!1,i&&i.close()}},[a]),[e,r]},At=()=>{Z&&w.post(k("/api/services/button/press"),{entity_id:Z}).catch(e=>{v.error("Failed to unlatch front door:",e)})},Tt=e=>{if(!e)return"";if(!e.includes("/")&&!e.includes(":"))return e;const n=e.match(/\/([^\/]+?)(?:\/whep)?(?:\?|$)/);return n?n[1]:e.split("?")[0].split("/").filter(Boolean).pop()||e},P=({src:e,show:n,orientation:r="landscape",...s})=>{const a=Tt(e),i=`${gt}/stream.html?src=${a}`;return n?t.jsx("iframe",{src:i,className:r,allow:"autoplay; fullscreen",...s}):null},ee=45e3,kt=b.div`
...
`,Dt=()=>{if(!Se)return null;const[e,n]=d.useState(!1),[r,s]=St(),[a,i]=d.useState(void 0),[c,o]=d.useState(100),[u,l]=d.useState("0");d.useEffect(()=>{if(r==="off"&&e){const x=window.setTimeout(()=>{n(!1),i(void 0)},ee);return i(x),l(ee+"ms"),o(0),()=>{x&&window.clearTimeout(x)}}else r==="on"&&(l(0),o(100),n(!0))},[r,e]),d.useEffect(()=>{r==="on"&&a!==void 0&&(window.clearTimeout(a),l(0),o(100),i(void 0))},[a,r]);const[f,h]=d.useState(!1),m=()=>{At(),h(!0)};return d.useEffect(()=>{if(f){const x=setTimeout(()=>h(!1),1e3);return()=>clearTimeout(x)}},[f]),t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>n(x=>!x),children:"CCTV"}),t.jsx(I,{visible:e,onClick:()=>n(!1),fullsize:!0,children:t.jsxs(kt,{children:[t.jsx(De,{completed:c,height:10,bgColor:a===void 0?"none":"#c0bfbf",isLabelVisible:!1,baseBgColor:"",transitionDuration:u,transitionTimingFunction:"linear"}),s!==!1&&t.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[t.jsx("h3",{children:"Fehler!"}),t.jsx("div",{children:s instanceof Error?s.message:String(s)})]}),t.jsx("div",{className:"grid",style:{display:e?"flex":"none"},children:(()=>{const x=H.filter(E=>(E.orientation||"landscape")==="portrait"),q=H.filter(E=>(E.orientation||"landscape")==="landscape"),J=H.filter(E=>E.orientation==="wide");return t.jsxs(t.Fragment,{children:[J.length>0&&t.jsx("div",{className:"wide-section",onClick:()=>m(),children:J.map((E,L)=>t.jsx("div",{style:{flex:1,minWidth:0,display:"flex",justifyContent:"center",alignItems:"center"},children:t.jsx(P,{src:E.name,show:e,orientation:"wide"})},L))}),t.jsxs("div",{className:"main-section",children:[x.length>0&&t.jsx("div",{onClick:()=>m(),style:{flexDirection:"column",gap:"12px",height:"100%"},children:x.map((E,L)=>t.jsx("div",{style:{flex:1,minHeight:0,display:"flex",justifyContent:"center",alignItems:"stretch",height:"100%"},children:t.jsx(P,{src:E.name,show:e,orientation:"portrait"})},L))}),q.length>0&&t.jsx("div",{onClick:()=>m(),style:{flexDirection:"column",gap:"12px",height:"100%"},children:q.map((E,L)=>t.jsx("div",{style:{flex:1,minHeight:0,display:"flex",justifyContent:"center",alignItems:"stretch",height:"100%"},children:t.jsx(P,{src:E.name,show:e,orientation:"landscape"})},L))})]})]})})()}),f&&t.jsx("div",{className:"open-door",children:"Tür öffnet sich"})]})})]})},Ct=b.div`
  display: flex;
...
`,kn=()=>{if(!Ee)return null;const[e,n,r]=Sn(),[s,a]=d.useState(!1),i=p.useCallback(()=>{r===!1&&a(!0)},[r]),c=p.useCallback(()=>a(!1),[]);return t.jsxs(Tn,{className:j({disabled:r!==!1}),children:[t.jsx("h2",{children:"Wäsche"}),t.jsx("div",{className:"status",onClick:i,children:r!==!1?t.jsxs(t.Fragment,{children:[t.jsx(T,{path:de,size:"2rem",color:"#f85a5a"}),t.jsx("span",{children:"Fehler"})]}):t.jsxs(t.Fragment,{children:[t.jsx("div",{className:j({animate:e.animate}),children:t.jsx(T,{path:e.icon,size:"2rem",color:"#ffffff"})}),t.jsx("span",{children:e.label})]})}),t.jsx(I,{visible:s&&r===!1,onClick:c,children:t.jsx("div",{className:"states",children:n.map((o,u)=>t.jsxs("div",{children:[t.jsx("div",{className:j({animate:S[o.state].animate}),children:t.jsx(T,{path:S[o.state].icon,size:2})}),t.jsx("div",{children:S[o.state].label}),t.jsx("div",{className:"subtitle",children:o.label})]},u))})})]})},Dn=p.memo(kn),Cn=b.div`
  padding: 0 0 0 24px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`;function Mn(){return _n(),t.jsx(W,{children:t.jsxs(In,{children:[t.jsx(On,{}),t.jsxs("div",{className:"main",children:[t.jsx(W,{children:t.jsx(Yt,{})}),t.jsx(W,{children:t.jsx(Ln,{})})]}),t.jsx(Ge,{})]})})}const Wn=Ue.createRoot(document.getElementById("root"));Wn.render(t.jsx(d.StrictMode,{children:t.jsx(W,{children:t.jsx(Mn,{})})}));
