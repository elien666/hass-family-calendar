import{r as e}from"./rolldown-runtime-S-ySWqyJ.js";import{C as t,E as n,S as r,T as i,_ as a,a as o,b as s,c,d as l,f as u,g as d,h as f,i as p,l as m,m as h,n as g,o as _,p as v,r as y,s as b,t as x,u as S,v as C,w,x as T,y as E}from"./react-vendor-Con0ipFJ.js";import{t as D}from"./date-vendor-D_7ccWj6.js";import{t as O}from"./vendor-74THNpNE.js";import{S as k,_ as A,a as ee,b as j,c as te,d as ne,f as re,g as ie,i as ae,l as oe,m as se,n as ce,o as le,r as ue,s as de,t as fe,u as pe,v as me,x as he,y as ge}from"./ui-vendor-C_gJ6dcx.js";import{n as M,t as _e}from"./utils-vendor-vFbNGt9E.js";import{t as ve}from"./chart-vendor-DU9mz6Ug.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var N=e(n(),1),ye=e(i(),1),P=e(E(),1),F=typeof P.default==`function`&&P.default||P.default?.default||P.default?.Icon||P.Icon,I=C(),be=s.div`
  position: absolute;
  top: 0;
  left: 0;
  width: 100vw;
...
`,vt=({on:e,month:t,day:n})=>{let[r,i]=e,a=r.indexOf(`${t}-${n}`),o=a>-1,s=()=>{i(o?r.toSpliced(a,1):[...r,`${t}-${n}`])};return(0,I.jsx)(`div`,{className:O(`dot`,{on:o}),onClick:()=>s(e=>!e)})},yt=()=>{let e=V();if(!e.ENABLE_EVERYDAY_CALENDAR)return null;let t=new Date().getFullYear(),n=[];for(let e=1;e<13;e++){let r=new Date(t,e,0).getDate();for(let t=1;t<=r;t++)n.push({month:e,day:t})}let r=Array.from({length:31},(e,t)=>t+1),i=Array.from({length:12},(e,t)=>t+1),o=N.useState(void 0),[s,c]=ht();return N.useEffect(()=>{s!==null&&o[1](s)},[s]),N.useEffect(()=>{o[0]!==void 0&&gt(o[0],e)},[o[0],e]),o[0]===void 0?(0,I.jsx)(_t,{className:`loading`,children:c===!1?(0,I.jsx)(a,{visible:!0,height:`80`,width:`80`,color:`#c1c1c1`,radius:`9`,ariaLabel:`three-dots-loading`,wrapperStyle:{},wrapperClass:``}):(0,I.jsxs)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`},children:[(0,I.jsx)(`h3`,{children:`Fehler!`}),(0,I.jsx)(`div`,{children:c instanceof Error?c.message:String(c)})]})}):(0,I.jsxs)(_t,{children:[(0,I.jsx)(`h2`,{children:`Jeden Tag ein bißchen`}),c!==!1&&(0,I.jsxs)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`,marginBottom:`1rem`},children:[(0,I.jsx)(`h3`,{children:`Fehler!`}),(0,I.jsx)(`div`,{children:c instanceof Error?c.message:String(c)})]}),(0,I.jsxs)(`div`,{className:`calendar`,children:[r.map((e,t)=>(0,I.jsx)(`div`,{style:{gridArea:`${e+1} / 1 / ${e+1} / 1`},children:e},t)),i.map((e,t)=>(0,I.jsx)(`div`,{style:{gridArea:`1 / ${e+1} / 1 / ${e+1}`},children:e},t)),n.map((e,t)=>(0,I.jsx)(`div`,{style:{gridArea:`${e.day+1} / ${e.month+1} / ${e.day+1} / ${e.month+1}`},children:(0,I.jsx)(vt,{on:o,month:e.month,day:e.day})},t))]})]})},bt=s.div`
...
`,Vt=()=>{let e=V(),t=e.ENABLE_DOORBELL||!1,n=e.DOORBELL_CAMERAS||[],[r,i]=N.useState(!1),[a,o]=wt(),[s,c]=N.useState(void 0),[l,u]=N.useState(100),[d,f]=N.useState(`0`),p=N.useMemo(()=>n.map(e=>e.entity_id).filter(Boolean),[n]),[m,h]=N.useState({}),[g,_]=N.useState(!1),[v,y]=N.useState(null),b=N.useRef(e);N.useEffect(()=>{b.current=e},[e]);let x=N.useRef(null);N.useEffect(()=>{if(r&&p.length>0){let e=new AbortController;return _(!0),y(null),kt(p,b.current,e.signal).then(({tokens:t,error:n})=>{e.signal.aborted||(h(t),y(n),_(!1))}).catch(t=>{e.signal.aborted||(z.error(`Failed to fetch camera tokens:`,t),y(G(t)),_(!1))}),()=>{e.abort()}}else r||(h({}),y(null),x.current?.abort())},[r,p.join(`,`)]);let S=N.useCallback(async()=>{if(p.length===0)return;x.current?.abort();let e=new AbortController;x.current=e,_(!0),y(null);try{let{tokens:t,error:n}=await kt(p,b.current,e.signal);e.signal.aborted||(h(t),y(n))}catch(t){e.signal.aborted||(z.error(`Failed to refresh camera tokens:`,t),y(G(t)))}finally{e.signal.aborted||_(!1)}},[p]),{isConnected:C}=ft(),w=N.useRef(!1);N.useEffect(()=>{C?w.current&&(w.current=!1,r&&p.length>0&&(z.debug(`Connection restored while doorbell overlay open — refreshing camera tokens`),S())):w.current=!0},[C,r,p,S]),N.useEffect(()=>{if(!r||p.length===0)return;let e=setInterval(()=>{z.debug(`Periodic camera token refresh`),S()},ze);return()=>clearInterval(e)},[r,p,S]);let[T,E]=N.useState(null),D=N.useRef(new Map),O=N.useCallback(()=>{D.current.forEach(e=>{e&&(e.src=`data:,`)}),D.current.clear()},[]),k=N.useRef(0),A=N.useRef(!1),ee=N.useCallback(()=>{k.current=Date.now(),A.current=!0,O(),i(!1),E(null)},[O]);N.useEffect(()=>{if(a===`off`){if(A.current=!1,r){let e=window.setTimeout(()=>{O(),i(!1),c(void 0)},Le);return c(e),f(Le+`ms`),u(0),()=>{e&&window.clearTimeout(e)}}}else if(a===`on`){let e=Date.now()-k.current<Re;if(A.current||e)return;f(0),u(100),i(!0)}},[a,r]),N.useEffect(()=>{a===`on`&&s!==void 0&&(window.clearTimeout(s),f(0),u(100),c(void 0))},[s,a]);let j=()=>{T===null?E(`confirm`):T===`confirm`&&(E(`opening`),Tt(e),setTimeout(()=>E(null),2e3))};return N.useEffect(()=>{if(T===`confirm`){let e=setTimeout(()=>{E(null)},3e3);return()=>{clearTimeout(e)}}},[T]),N.useEffect(()=>{r||E(null)},[r]),t?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`button`,{onClick:()=>{r?ee():i(!0)},children:`CCTV`}),(0,I.jsx)(L,{visible:r,onClick:j,onClose:ee,fullsize:!0,children:(0,I.jsxs)(Bt,{onClick:j,children:[(0,I.jsx)(Et.default,{completed:l,height:10,bgColor:s===void 0?`none`:`#c0bfbf`,isLabelVisible:!1,baseBgColor:``,transitionDuration:d,transitionTimingFunction:`linear`}),(0,I.jsx)(`div`,{className:`grid`,children:(0,I.jsx)(zt,{cameras:n,accessTokens:m,tokensLoading:g,tokensError:v,refreshTokens:S,showDoorCams:r,cameraImgRefs:D,openDoor:j,config:e})}),T===`confirm`&&(0,I.jsx)(`div`,{className:`open-door confirm`,children:`Haustür öffnen?`}),T===`opening`&&(0,I.jsx)(`div`,{className:`open-door opening`,children:`Öffne die Tür!`})]})})]}):null},Ht=s.div`
  display: flex;
...
`,Ut=(0,N.memo)(({nextWeek:e,previousWeek:t,startWeekWithToday:n})=>(0,I.jsxs)(Ht,{children:[(0,I.jsxs)(`div`,{className:`buttons`,children:[(0,I.jsx)(F,{path:pe,size:`32px`,color:`#ffffff`,onClick:t}),(0,I.jsx)(F,{path:ne,size:`32px`,color:`#ffffff`,onClick:e}),(0,I.jsx)(`button`,{onClick:n,children:`Today`}),(0,I.jsx)(Vt,{})]}),(0,I.jsx)(xt,{}),(0,I.jsx)(F,{path:ge,size:`32px`,color:`#ffffff`,className:O(`indicator`)})]})),Wt=e(_e(),1),Gt=6e4,Kt=(e=Gt,t=void 0)=>{let[n,r]=N.useState(!0);return N.useEffect(()=>{let t=setInterval(()=>{r(e=>!e)},e);return()=>{clearInterval(t)}},[e,t]),n},qt={mdiDelete:se,mdiCake:oe},Jt=e=>{if(!(!e||typeof e!=`string`))return qt[e.startsWith(`mdi`)?e:`mdi${e.charAt(0).toUpperCase()+e.slice(1)}`]||void 0},Yt=(e,t,n,r,i,a)=>M(i(e.name,{start:t.toISO(),end:n.toISO()}),{timeout:65e3,signal:a}).then(n=>{!n.data||!Array.isArray(n.data)||n.data.forEach(n=>{let i=`dateTime`in n.start?D.fromISO(n.start.dateTime):D.fromSQL(n.start.date),a;a=`dateTime`in n.end?Math.floor(D.fromISO(n.end.dateTime).diff(t,`days`).as(`days`)):Math.floor(D.fromSQL(n.end.date).diff(t,`days`).as(`days`))-1;let o=Math.floor(i.diff(t,`days`).as(`days`));a>=r.length&&(a=r.length-1);let s=`dateTime`in n.start?`events`:`allDay`;if(o>=0&&o<r.length)for(let t=o;t<=a;t++)r[t][s]=[...r[t][s],{...n,icon:e.icon}]})}).catch(e=>{if(!(M.isCancel(e)||e.name===`AbortError`||e.code===`ERR_CANCELED`))throw e}),Xt=new Map,Zt=300*1e3,Qt=e=>e.toISODate(),$t=(e,t,n,r,i,a,o,s,c)=>{let l=[0,1,2,3,4,5].map(t=>e.plus({days:t}).startOf(`day`));l[6]=e.plus({days:6}).endOf(`day`);let u=Qt(e),d=Xt.get(u);if(d&&Date.now()-d.timestamp<Zt){c.current&&n(d.data);return}let f=l.map(e=>({date:e,allDay:[],events:[]}));if(!o||o.length===0){z.warn(`loadAll: No calendars configured, skipping fetch`,{calendars:o}),c.current&&(n(f),r(!1));return}z.debug(`loadAll: Starting calendar fetch`,{calendarsCount:o.length,calendars:o.map(e=>e.name),startDate:e.toISO(),endDate:l[6].toISO()});let p=new AbortController;i.current&&i.current.abort(),i.current=p;try{c.current&&r(!0);let e=o.map(e=>Yt(e,l[0],l[6],f,s,p.signal));Promise.all(e).then(()=>{c.current&&!p.signal.aborted&&(Xt.set(u,{data:f,timestamp:Date.now()}),n(f),a(!1))}).catch(e=>{c.current&&!p.signal.aborted&&a(G(e))}).finally(()=>{c.current&&!p.signal.aborted&&r(!1)})}catch(e){c.current&&!p.signal.aborted&&(a(G(e)),r(!1))}},en=[],tn=e=>{let t=V(),n=t.CALENDARS||[];N.useEffect(()=>{z.debug(`useCalendarData: config changed`,{hasCALENDARS:`CALENDARS`in t,CALENDARS:t.CALENDARS,CALENDARSCount:Array.isArray(t.CALENDARS)?t.CALENDARS.length:`not array`,configKeys:Object.keys(t)})},[t]);let r=N.useMemo(()=>{let e=n.map(e=>({name:e.name,icon:Jt(e.icon)}));return z.debug(`Processing calendars from config (memo update):`,{CALENDARS:n,count:n.length,processedCount:e.length,processed:e.map(e=>e.name)}),e},[n]);N.useEffect(()=>{z.debug(`CALENDARS array changed:`,{CALENDARS:n,count:n.length,calendarsMemoCount:r.length})},[n,r.length]);let i=N.useCallback(e=>{let n=K(`/api/calendars/${e}`,t);return z.debug(`Building calendar URL for ${e}:`,n),n},[t]),a=N.useCallback((e,t)=>{let n=`${i(e)}?${Wt.default.stringify(t)}`;return z.debug(`Full calendar URL for ${e}:`,n),n},[i]),[o,s]=N.useState(en),[c,l]=N.useState(!1),[u,d]=N.useState(!1),[f,p]=N.useState(null),m=(0,N.useRef)(null),h=(0,N.useRef)(!0);return Kt(6e4,`Calendar`),N.useEffect(()=>(h.current=!0,z.debug(`useCalendarData effect triggered:`,{startDate:e?.toISO(),calendarsCount:r.length,calendars:r.map(e=>e.name),hasStartDate:e!==void 0,hasCalendars:r.length>0}),e!==void 0&&r.length>0?((f===null||!f.equals(e))&&(s(en),p(e)),z.debug(`useCalendarData: Calling loadAll`,{startDate:e.toISO(),calendarsCount:r.length}),$t(e,o,s,l,m,d,r,a,h)):(e===void 0&&z.debug(`useCalendarData: startDate is undefined, skipping fetch`),r.length===0&&z.debug(`useCalendarData: No calendars configured yet, skipping fetch`)),()=>{h.current=!1,m.current&&m.current.abort()}),[e,r,a]),[o,u]};function nn(e){let[t,n]=N.useState(!1);function r({key:t}){t===e&&n(!0)}let i=({key:t})=>{t===e&&n(!1)};return N.useEffect(()=>(window.addEventListener(`keydown`,r),window.addEventListener(`keyup`,i),()=>{window.removeEventListener(`keydown`,r),window.removeEventListener(`keyup`,i)}),[e]),t}var rn=()=>{let e=new Date,t=(e.getDay()+6)%7,n=new Date(e.setDate(e.getDate()-t));return D.fromJSDate(n)},an=e=>{let t=()=>e(e=>e.plus({days:7})),n=nn(`ArrowRight`);N.useEffect(()=>{n&&t()},[n]);let r=()=>e(e=>e.minus({days:7})),i=nn(`ArrowLeft`);N.useEffect(()=>{i&&r()},[i]);let a=()=>e(rn()),o=nn(`t`);return N.useEffect(()=>{o&&a()},[o]),{nextWeek:t,previousWeek:r,startWeekWithToday:a}},on=e=>{let[t,n]=(0,N.useState)(0),[r,i]=(0,N.useState)(0);return{onTouchStart:e=>{i(0),n(e.targetTouches[0].clientX)},onTouchMove:e=>i(e.targetTouches[0].clientX),onTouchEnd:()=>{if(!t||!r)return;let n=t-r,i=n>50,a=n<-50;i&&e.onSwipedLeft(),a&&e.onSwipedRight()}}},sn=e=>D.fromISO(e).toLocaleString(D.TIME_24_SIMPLE),cn=e=>e.toFormat(`c`)>=6,ln=e=>e.hasSame(D.now(),`day`),un=s.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  overflow: hidden;
...
`,dn=()=>{let[e,t]=N.useState(void 0),[n,r]=tn(e),{nextWeek:i,previousWeek:o,startWeekWithToday:s}=an(t);N.useEffect(()=>{e===void 0&&s()},[]);let c=on({onSwipedLeft:()=>i(),onSwipedRight:()=>o()}),l=(0,N.useMemo)(()=>({weekday:`short`,month:`numeric`,day:`numeric`}),[]),u=(0,N.useMemo)(()=>n.slice(0,7),[n]);return(0,I.jsxs)(un,{...c,children:[(0,I.jsx)(Ut,{nextWeek:i,previousWeek:o,startWeekWithToday:s}),(0,I.jsxs)(`div`,{className:`schedule`,children:[u.map((e,t)=>(0,I.jsx)(`div`,{className:O({weekend:cn(e.date),today:ln(e.date)},`caption`),children:(0,I.jsx)(`h2`,{children:e.date.toLocaleString(l)})},t)),u.map((e,t)=>(0,I.jsx)(`div`,{className:O(`allDayRow`,{weekend:cn(e.date),today:ln(e.date)}),children:e.allDay.map((e,t)=>(0,I.jsx)(`div`,{className:`allDayEvent`,children:e.summary},t))},t)),u.map((e,t)=>(0,I.jsx)(`div`,{className:O(`eventRow`,{weekend:cn(e.date),today:ln(e.date)}),children:e.events.map((e,t)=>(0,I.jsxs)(`div`,{className:`event`,children:[(0,I.jsx)(`div`,{children:e.summary}),(0,I.jsxs)(`h3`,{children:[e.icon&&(0,I.jsx)(F,{path:e.icon,size:`1rem`,color:`#ffffff`}),sn(e.start.dateTime),` - `,sn(e.end.dateTime)]})]},t))},t))]}),n.length===0&&(0,I.jsx)(`div`,{className:`loading`,children:r===!1?(0,I.jsx)(a,{visible:!0,height:`80`,width:`80`,color:`#c1c1c1`,radius:`9`,ariaLabel:`three-dots-loading`,wrapperStyle:{},wrapperClass:``}):(0,I.jsxs)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`},children:[(0,I.jsx)(`h3`,{children:`Fehler beim Laden der Kalenderdaten`}),(0,I.jsx)(`div`,{children:r instanceof Error?r.message:String(r)})]})}),r!==!1&&n.length>0&&(0,I.jsx)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`,marginTop:`1rem`},children:(0,I.jsxs)(`div`,{children:[`Warnung: `,r instanceof Error?r.message:String(r)]})})]})},fn=s.div`
...
`,X=class extends N.Component{constructor(e){super(e),this.state={hasError:!1,error:null,errorInfo:null}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,t){this.setState({error:e,errorInfo:t});let n=e?.toString()||`Unknown error`,r=e?.stack||``,i=t?.componentStack||``;z.error(`ErrorBoundary caught an error: ${n}`,{errorName:e?.name,errorMessage:n,errorStack:r,componentStack:i})}handleReset=()=>{this.setState({hasError:!1,error:null,errorInfo:null})};handleReload=()=>{window.location.reload()};render(){if(this.state.hasError){let e=this.props.compact;return(0,I.jsxs)(fn,{$compact:e,children:[(0,I.jsx)(`h2`,{children:e?`Fehler`:`Something went wrong`}),!e&&(0,I.jsx)(`p`,{children:`The application encountered an error. Please try reloading the page.`}),!1,(0,I.jsxs)(`div`,{children:[(0,I.jsx)(`button`,{onClick:this.handleReset,children:`Try Again`}),(0,I.jsx)(`button`,{onClick:this.handleReload,style:{marginLeft:`0.5rem`},children:`Reload Page`})]})]})}return this.props.children}},pn={"clear-day":{icon:c,label:`Klar`,color:`#eeeef5`},"clear-night":{icon:S,label:`Klar`,color:`#eeeef5`},rain:{icon:u,label:`Regen`,color:`#80a5d6`},snow:{icon:h,label:`Schnee`,color:`#8c82ce`},sleet:{icon:v,label:`Graupel`,color:`#aba4db`},wind:{icon:f,label:`Stürmisch`,color:`#9fb6d6`},fog:{icon:m,label:`Neblig`,color:`#d5dae2`},cloudy:{icon:_,label:`Bewölkt`,color:`#b6bfcb`},"partly-cloudy-day":{icon:b,label:`Teils bewölkt`,color:`#d5dae2`},"partly-cloudy-night":{icon:l,label:`Teils bewölkt`,color:`#d5dae2`}},mn=e=>{let[t,n]=N.useState([]),[r,i]=N.useState(!1),a=Kt(6e4*10,`Weather`),o=V(),s=o.ENABLE_WEATHER||!1,c=o.WEATHER_LATITUDE,l=o.WEATHER_LONGITUDE,u=s&&c&&l,d=()=>`.${`/forecast/${c},${l}?units=si&exclude=minutely`}`;return N.useEffect(()=>{if(!u){e&&e(!1);return}let t=!0,r=new AbortController;return e&&e(!0),M(d(),{signal:r.signal}).then(e=>{t&&(n(e.data),i(!1))}).catch(e=>{t&&!r.signal.aborted&&i(G(e))}).finally(()=>{t&&e&&e(!1)}),()=>{t=!1,r.abort()}},[a,e,u,s,c,l]),[t,r]},hn=y(p),gn=s.div`
...
`,On=(0,N.memo)(({line:e,direction:t,realtimeOffset:n})=>(0,I.jsxs)(`div`,{className:`departure`,children:[(0,I.jsx)(`div`,{children:(0,I.jsx)(`img`,{src:`https://cloud.geofox.de/icon/linename?name=${e}&outlined=true&fileFormat=SVG&height=14&appearance=COLOURED`,alt:`Linie ${e}`})}),(0,I.jsx)(`div`,{children:n===0?`Jetzt`:(0,I.jsxs)(I.Fragment,{children:[`in `,n,` '`]})})]})),kn=(0,N.memo)(()=>{let e=V().ENABLE_HVV||!1,[t,n]=En(Sn.departureList);return e?(0,I.jsx)(Dn,{children:n===!1?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`h3`,{children:`→\xA0Wandsbek`}),t.to?.map((e,t)=>(0,I.jsx)(On,{line:e.line,direction:e.direction,realtimeOffset:e.realtimeOffset},t)),(0,I.jsx)(`h3`,{children:`→\xA0Stadtauswärts`}),t.from?.map((e,t)=>(0,I.jsx)(On,{line:e.line,direction:e.direction,realtimeOffset:e.realtimeOffset},t))]}):(0,I.jsxs)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`},children:[(0,I.jsx)(`h3`,{children:`Fehler!`}),(0,I.jsx)(`div`,{children:n instanceof Error?n.message:String(n)})]})}):null}),An=()=>{let e=V(),t=e.ENABLE_EV||!1,n=e.ENTITY_PRECLIMATE_STATUS||``,r=e.ENTITY_CHARGING_STATE||``,i=e.ENTITY_STATE_OF_CHARGE||``,a=t&&(n||r||i),[o,s,c]=q({entityId:n,enabled:a&&!!n,config:e,initialState:`off`}),{error:l}=Ct({entityId:n,enabled:a&&!!n,onStateUpdate:c,logPrefix:`EV preclimate`,wsOptions:{checkBackendConnection:!1,reconnectStrategy:`exponential`,maxReconnectAttempts:5,reconnectDelay:1e3}}),[u,d,f]=q({entityId:r,enabled:a&&!!r,config:e,initialState:`off`}),{error:p}=Ct({entityId:r,enabled:a&&!!r,onStateUpdate:f,logPrefix:`EV charging`,wsOptions:{checkBackendConnection:!1,reconnectStrategy:`exponential`,maxReconnectAttempts:5,reconnectDelay:1e3}}),[m,h,g]=q({entityId:i,enabled:a&&!!i,config:e,initialState:`0`}),{error:_}=Ct({entityId:i,enabled:a&&!!i,onStateUpdate:g,logPrefix:`EV SoC`,wsOptions:{checkBackendConnection:!1,reconnectStrategy:`exponential`,maxReconnectAttempts:5,reconnectDelay:1e3}});return[N.useMemo(()=>({preclimateStatus:o===`on`,chargingState:u===`on`,stateOfCharge:parseFloat(m)||0}),[o,u,m]),s||l||d||p||h||_||!1]},jn=e=>{let t=e?.ENTITY_PRECLIMATE_START||``;t&&M.post(K(`/api/services/button/press`,e),{entity_id:t}).catch(e=>{z.error(`Failed to start preclimate:`,e)})},Mn=e=>{let t=e?.ENTITY_PRECLIMATE_STOP||``;t&&M.post(K(`/api/services/button/press`,e),{entity_id:t}).catch(e=>{z.error(`Failed to stop preclimate:`,e)})},Nn=({preclimateStatus:e,error:t,onStart:n,onStop:r})=>{let[i,a]=(0,N.useState)(!1),[o,s]=(0,N.useState)(null),[c,l]=(0,N.useState)(!1),[u,d]=(0,N.useState)(!1),[f,p]=(0,N.useState)(0),m=(0,N.useRef)(null),h=(0,N.useRef)(null),g=(0,N.useRef)(e),_=(0,N.useRef)(null);return(0,N.useEffect)(()=>{g.current!==e&&(i&&_.current!==null&&e===(o===`start`)&&(p(o===`start`?360:0),d(!0),setTimeout(()=>{a(!1),s(null),d(!1),p(0),_.current=null,l(!1)},300),m.current&&=(clearTimeout(m.current),null)),g.current=e)},[e,i,o]),(0,N.useEffect)(()=>{if(!i||u){h.current&&=(cancelAnimationFrame(h.current),null);return}let e=_.current||Date.now(),t=o===`stop`,n=()=>{let r=Date.now()-e,i=Math.min(r/Be,1);p(t?360*(1-i):360*i),i<1&&!u&&(h.current=requestAnimationFrame(n))};return h.current=requestAnimationFrame(n),()=>{h.current&&=(cancelAnimationFrame(h.current),null)}},[i,u,o]),(0,N.useEffect)(()=>()=>{m.current&&clearTimeout(m.current),h.current&&cancelAnimationFrame(h.current)},[]),{isAnimating:i,animationDirection:o,shouldShake:c,isComplete:u,progressAngle:f,handleToggle:(0,N.useCallback)(()=>{if(t!==!1||i)return;let o=!e,c=o?`start`:`stop`;a(!0),s(c),d(!1),l(!1),p(0),_.current=Date.now(),g.current=e,o?n():r(),m.current=setTimeout(()=>{l(!0),setTimeout(()=>{a(!1),s(null),d(!1),p(0),l(!1),_.current=null},500)},Ve)},[e,t,i,n,r])}},Pn=s.div`
  padding-bottom: 12px;
...
`,Fn=(e,t)=>t?ae:e>=80?ee:e>=50?de:e>=20?le:te,In=e=>e>=90?`#17e146`:e>=40?`#ff9800`:`#f85a5a`,Ln=(0,N.memo)(()=>{let e=V(),t=e.ENABLE_EV||!1,[n,r]=An(),{preclimateStatus:i,chargingState:a,stateOfCharge:o}=n,{isAnimating:s,animationDirection:c,shouldShake:l,isComplete:u,progressAngle:d,handleToggle:f}=Nn({preclimateStatus:i,error:r,onStart:(0,N.useCallback)(()=>jn(e),[e]),onStop:(0,N.useCallback)(()=>Mn(e),[e])}),p=Fn(o||0,a),m=In(o||0),h=Math.round(o||0),g=s?c===`start`:i,_=c===`start`?`#17e146`:`#f85a5a`,v=c===`start`?`clockwise`:`counterclockwise`;return t?(0,I.jsxs)(Pn,{className:O({disabled:r!==!1}),children:[(0,I.jsxs)(`h2`,{children:[`Auto`,r===!1?(0,I.jsxs)(`div`,{className:`battery-info`,children:[(0,I.jsxs)(`span`,{className:`charge-percentage`,children:[h,`%`]}),(0,I.jsx)(F,{path:p,size:`1.2rem`,color:m})]}):(0,I.jsxs)(`div`,{className:`battery-info`,children:[(0,I.jsx)(F,{path:fe,size:`1.2rem`,color:`#f85a5a`}),(0,I.jsx)(`span`,{children:`Fehler`})]})]}),r===!1&&(0,I.jsxs)(`div`,{className:`preclimate-button-wrapper`,children:[s&&(0,I.jsx)(`div`,{className:O(`progress-ring`,v,{complete:u}),style:{"--progress-color":_,"--progress-angle":`${d}deg`,"--progress-gradient":`conic-gradient(from -90deg, ${_} 0deg, ${_} ${d}deg, transparent ${d}deg, transparent 360deg)`}}),(0,I.jsxs)(`button`,{className:O(`preclimate-button`,{spinning:g&&!s,shaking:l}),onClick:f,disabled:r!==!1||s,children:[(0,I.jsx)(F,{path:`M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12.5,2C17,2 17.11,5.57 14.75,6.75C13.76,7.24 13.32,8.29 13.13,9.22C13.61,9.42 14.03,9.73 14.35,10.13C18.05,8.13 22.03,8.92 22.03,12.5C22.03,17 18.46,17.1 17.28,14.73C16.78,13.74 15.72,13.3 14.79,13.11C14.59,13.59 14.28,14 13.88,14.34C15.87,18.03 15.08,22 11.5,22C7,22 6.91,18.42 9.27,17.24C10.25,16.75 10.69,15.71 10.89,14.79C10.4,14.59 9.97,14.27 9.65,13.87C5.96,15.85 2,15.07 2,11.5C2,7 5.56,6.89 6.74,9.26C7.24,10.25 8.29,10.68 9.22,10.87C9.41,10.39 9.73,9.97 10.14,9.65C8.15,5.96 8.94,2 12.5,2Z`,size:`2rem`,color:g?`#ff9800`:`#ffffff`}),(0,I.jsx)(`span`,{children:g?`Stop`:`Start`})]})]})]}):null}),Rn=()=>{let e=V(),t=e.ENABLE_GARAGE||!1,n=e.ENTITY_GARAGE_DOOR||``,r=t&&n,[i,a,o]=q({entityId:n,enabled:r,config:e,initialState:`closed`}),{error:s}=Ct({entityId:n,enabled:r,onStateUpdate:o,logPrefix:`garage door`});return[i,a||s||!1]},zn=(e,t={})=>{let n=t.ENTITY_GARAGE_DOOR||``;if(!n)return;e(!0);let r=setTimeout(()=>e(!1),He);M.post(K(`/api/services/cover/toggle`,t),{entity_id:n}).catch(e=>{z.error(`Failed to toggle garage door:`,e)}).finally(()=>{clearTimeout(r),e(!1)})},Bn=(e,t={})=>{let n=t.ENTITY_GARAGE_DOOR||``;if(!n)return;e(!0);let r=setTimeout(()=>e(!1),He);M.post(K(`/api/services/cover/open_cover`,t),{entity_id:n}).catch(e=>{z.error(`Failed to open garage door:`,e)}).finally(()=>{clearTimeout(r),e(!1)})},Vn=(e,t={})=>{let n=t.ENTITY_GARAGE_DOOR||``;if(!n)return;e(!0);let r=setTimeout(()=>e(!1),He);M.post(K(`/api/services/cover/close_cover`,t),{entity_id:n}).catch(e=>{z.error(`Failed to close garage door:`,e)}).finally(()=>{clearTimeout(r),e(!1)})},Hn=s.div`
  padding-bottom: 12px;
...
`,Wn=e=>{let t={unknown:{label:`In Bewegung oder halb-offen`,icon:ie},open:{label:`Offen`,icon:A},closed:{label:`Geschlossen`,icon:me},opening:{label:`Öffnet`,icon:ue},closing:{label:`Schließt`,icon:ce}};return t[e]||z.warn(`Garage door state is not recognized:`,e,`Available states: unknown, open, closed, opening, closing`),t[e]||{label:`Unavailable`,icon:`M21.86 12.5C21.1 11.63 20.15 11.13 19 11C19 9.05 18.32 7.4 16.96 6.04C15.6 4.68 13.95 4 12 4C10.42 4 9 4.47 7.75 5.43S5.67 7.62 5.25 9.15C4 9.43 2.96 10.08 2.17 11.1S1 13.28 1 14.58C1 16.09 1.54 17.38 2.61 18.43C3.69 19.5 5 20 6.5 20H18.5C19.75 20 20.81 19.56 21.69 18.69C22.56 17.81 23 16.75 23 15.5C23 14.35 22.62 13.35 21.86 12.5M20.27 17.27C19.79 17.76 19.2 18 18.5 18H6.5C5.53 18 4.71 17.66 4.03 17C3.34 16.29 3 15.47 3 14.5S3.34 12.71 4.03 12.03C4.71 11.34 5.53 11 6.5 11H7C7 9.62 7.5 8.44 8.46 7.46C9.44 6.5 10.62 6 12 6S14.56 6.5 15.54 7.46C16.5 8.44 17 9.62 17 11V13H18.5C19.2 13 19.79 13.24 20.27 13.73S21 14.8 21 15.5 20.76 16.79 20.27 17.27M11 15H13V17H11V15M14.43 8.68C14.97 9.13 15.24 9.75 15.24 10.5C15.24 11 15.09 11.41 14.8 11.82C14.5 12.21 14.13 12.5 13.67 12.75C13.41 12.91 13.24 13.07 13.15 13.26C13.06 13.45 13 13.69 13 14H11C11 13.45 11.11 13.08 11.3 12.82C11.5 12.56 11.85 12.25 12.37 11.91C12.63 11.75 12.84 11.56 13 11.32C13.15 11.09 13.23 10.81 13.23 10.5C13.23 10.18 13.14 9.94 12.96 9.76C12.78 9.56 12.5 9.47 12.2 9.47C11.93 9.47 11.71 9.55 11.5 9.7C11.35 9.85 11.25 10.08 11.25 10.39H9.28C9.23 9.64 9.5 9 10.06 8.59C10.6 8.2 11.31 8 12.2 8C13.14 8 13.89 8.23 14.43 8.68Z`}},Gn=({garageDoor:e,animate:t=!1})=>(0,I.jsxs)(Un,{className:O({animate:t}),children:[(0,I.jsx)(F,{path:Wn(e).icon,size:`2rem`,color:`#ffffff`}),(0,I.jsx)(`span`,{children:Wn(e).label})]}),Kn=3e4,qn=e=>g.promise(e,{loading:`Garagentor ist in Bewegung …`,success:e=>Wn(e).label,error:`Nope`,duration:5e3}),Jn=(0,N.memo)(()=>{let e=V(),t=e.ENABLE_GARAGE||!1,[n,r]=Rn(),[i,a]=N.useState(void 0),[o,s]=N.useState(!1),[c,l]=N.useState(!1),u=N.useRef(n);N.useEffect(()=>{u.current=n},[n]),N.useEffect(()=>{if(n===`unknown`||n===`opening`||n===`closing`){if(!i){let e,t=new Promise(t=>{e=t}),n=window.setTimeout(()=>{e(u.current),a(void 0)},Kn);a({resolve:e,watchdogId:n}),qn(t)}}else i&&(window.clearTimeout(i.watchdogId),i.resolve(n),a(void 0))},[n]);let d=nn(`g`);N.useEffect(()=>{d&&r===!1&&zn(s,e)},[d,r,e]);let f=(0,N.useCallback)(t=>{if(r===!1)switch(l(!1),t){case`open`:Bn(s,e);break;case`close`:Vn(s,e);break;default:}},[s,r,e]),p=(0,N.useCallback)(()=>{r===!1&&l(!0)},[r]);return t?(0,I.jsxs)(Hn,{className:O({disabled:r!==!1}),children:[(0,I.jsx)(`h2`,{children:`Garage`}),(0,I.jsx)(`div`,{className:`status`,onClick:p,children:r===!1?(0,I.jsx)(Gn,{garageDoor:n,animate:o}):(0,I.jsxs)(Un,{children:[(0,I.jsx)(F,{path:fe,size:`2rem`,color:`#f85a5a`}),(0,I.jsx)(`span`,{children:`Fehler`})]})}),(0,I.jsx)(L,{visible:c&&r===!1,onClick:()=>l(!1),children:(0,I.jsxs)(`div`,{className:`controls`,children:[(0,I.jsx)(`h2`,{children:`Garagentor`}),(0,I.jsx)(`div`,{onClick:()=>f(`open`),children:`Öffnen`}),(0,I.jsx)(`div`,{onClick:()=>f(`close`),children:`Schließen`})]})})]}):null}),Yn=({entityIds:e,enabled:t,onStateUpdate:n,logPrefix:r,wsOptions:i={}})=>{let{error:a}=St({enabled:t&&e.length>0,logPrefix:r,...i,onReady:(t,i)=>(e.forEach(e=>{i.current.set(e,t=>{t.state!==void 0&&n(e,t.state)}),t.readyState===WebSocket.OPEN&&t.send(JSON.stringify({type:`subscribe_entity`,entity_id:e}))}),e.length>0&&z.debug(`Subscribed to ${r} state changes: ${e.join(`, `)}`),()=>{e.forEach(e=>{i.current.delete(e),t.readyState===WebSocket.OPEN&&t.send(JSON.stringify({type:`unsubscribe_entity`,entity_id:e}))})}),dependencies:[t,e.join(`,`)]});return{error:a}},Z={done:{label:`Fertig`,animate:!1,icon:he},off:{label:`Aus`,animate:!1,icon:k},standby:{label:`Standby`,animate:!1,icon:j},running:{label:`Läuft …`,animate:!0,icon:j}},Xn={off:0,standby:2,running:16,done:256},Zn=()=>{let e=V(),t=e.ENABLE_LAUNDRY||!1,n=e.LAUNDRY_MACHINES||[],r=Array.isArray(n)?n:[],i=N.useMemo(()=>r.filter(e=>e.entity_id).map(e=>e.entity_id),[r.map(e=>e.entity_id).join(`,`)]),[a,o]=N.useState({}),[s,c]=N.useState({}),l=N.useCallback((e,t)=>{o(n=>({...n,[e]:t}))},[]),{error:u}=Yn({entityIds:i,enabled:t&&i.length>0,onStateUpdate:l,logPrefix:`laundry`});N.useEffect(()=>{if(!t||i.length===0)return;let n=new Map;return i.forEach(t=>{let r=K(`/api/states/${t}`,e);if(!r)return;let i=new AbortController;n.set(t,i),M(r,{signal:i.signal}).then(e=>{o(n=>({...n,[t]:e.data.state})),c(e=>({...e,[t]:!1}))}).catch(e=>{i.signal.aborted||c(n=>({...n,[t]:G(e)}))})}),()=>{n.forEach(e=>e.abort())}},[t,i.join(`,`),e]);let d=r.map(e=>({state:a[e.entity_id]||`off`,error:s[e.entity_id]||u||!1,name:e.name})),[f,p]=N.useState(Z.off),[m,h]=N.useState(!1),g=d.map(e=>e.state),_=d.map(e=>e.error);return N.useEffect(()=>{h(_.some(e=>e!==!1)&&_.find(e=>e!==!1)||!1)},[_]),N.useEffect(()=>{let e=g.reduce((e,t)=>e+(Xn[t]||0),0);e===0?p(Z.off):e<16?p(Z.standby):e<256?p(Z.running):e%256==0?p(Z.done):e%256%16==0?p(Z.running):e%256%2==0?p(Z.done):p(Z.running)},[g]),[f,d.map(e=>({label:e.name,state:e.state})),m]},Qn=s.div`
  padding-bottom: 12px;
...
`,$n=(0,N.memo)(()=>{let e=V().ENABLE_LAUNDRY||!1,[t,n,r]=Zn(),[i,a]=N.useState(!1),o=(0,N.useCallback)(()=>{r===!1&&a(!0)},[r]),s=(0,N.useCallback)(()=>a(!1),[]);return e?(0,I.jsxs)(Qn,{className:O({disabled:r!==!1}),children:[(0,I.jsx)(`h2`,{children:`Wäsche`}),(0,I.jsx)(`div`,{className:`status`,onClick:o,children:r===!1?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`div`,{className:O({animate:t.animate}),children:(0,I.jsx)(F,{path:t.icon,size:`2rem`,color:`#ffffff`})}),(0,I.jsx)(`span`,{children:t.label})]}):(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(F,{path:fe,size:`2rem`,color:`#f85a5a`}),(0,I.jsx)(`span`,{children:`Fehler`})]})}),(0,I.jsx)(L,{visible:i&&r===!1,onClick:s,children:(0,I.jsxs)(`div`,{className:`states`,children:[(0,I.jsx)(`h2`,{children:`Wäsche`}),n.map((e,t)=>(0,I.jsxs)(`div`,{children:[(0,I.jsx)(`div`,{className:`subtitle`,children:e.label}),(0,I.jsx)(`div`,{className:O({animate:Z[e.state].animate}),children:(0,I.jsx)(F,{path:Z[e.state].icon,size:2})}),(0,I.jsx)(`div`,{children:Z[e.state].label})]},t))]})})]}):null}),er=s.div`
  padding: 0 0 0 24px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`;function jr(){let e=Ye(),t=Xe(),n=Je(),[r]=N.useState(()=>{try{if(typeof window<`u`&&window.localStorage)return localStorage.getItem(Er)===`true`}catch{}return!1});return(0,I.jsxs)(Ar,{$hasBanner:!n&&!r&&(e||t),children:[(0,I.jsx)(kr,{}),(0,I.jsx)(Or,{}),(0,I.jsxs)(`div`,{className:`main`,children:[(0,I.jsx)(X,{children:(0,I.jsx)(dn,{})}),(0,I.jsx)(X,{children:(0,I.jsx)(tr,{})})]}),(0,I.jsx)(x,{position:`bottom-center`,theme:`dark`,duration:5e3,closeButton:!0})]})}function Mr(){return(0,I.jsx)(X,{children:(0,I.jsxs)(w,{children:[(0,I.jsx)(t,{path:`/demo`,element:(0,I.jsx)(Tr,{})}),(0,I.jsx)(t,{path:`/tiling-demo`,element:(0,I.jsx)(Tr,{})}),(0,I.jsx)(t,{path:`*`,element:(0,I.jsx)(jr,{})})]})})}ye.createRoot(document.getElementById(`root`)).render((0,I.jsx)(N.StrictMode,{children:(0,I.jsx)(X,{children:(0,I.jsx)(qe,{children:(0,I.jsx)(dt,{children:(0,I.jsx)(r,{children:(0,I.jsx)(Mr,{})})})})})}));