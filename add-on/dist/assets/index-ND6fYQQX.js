...
`,ao=()=>{const e=V(),i=e.ENABLE_DOORBELL||!1,t=e.DOORBELL_CAMERAS||[];if(!i)return null;const[n,a]=_.useState(!1),[u]=Jt(),[g,p]=_.useState(void 0),[b,l]=_.useState(100),[f,E]=_.useState("0"),S=_.useMemo(()=>t.map(d=>d.entity_id).filter(Boolean),[t]),[y]=io(S);_.useEffect(()=>{if(u==="off"&&n){const d=window.setTimeout(()=>{a(!1),p(void 0)},ke);return p(d),E(ke+"ms"),l(0),()=>{d&&window.clearTimeout(d)}}else u==="on"&&(E(0),l(100),a(!0))},[u,n]),_.useEffect(()=>{u==="on"&&g!==void 0&&(window.clearTimeout(g),E(0),l(100),p(void 0))},[g,u]);const[h,m]=_.useState(null),s=()=>{h===null?m("confirm"):h==="confirm"&&(m("opening"),Qt(),setTimeout(()=>m(null),2e3))};return _.useEffect(()=>{if(h==="confirm"){const d=setTimeout(()=>{m(null)},3e3);return()=>{clearTimeout(d)}}},[h]),_.useEffect(()=>{n||m(null)},[n]),o.jsxs(o.Fragment,{children:[o.jsx("button",{onClick:()=>a(d=>!d),children:"CCTV"}),o.jsx(ce,{visible:n,onClick:s,onClose:()=>{a(!1),m(null)},fullsize:!0,children:o.jsxs(so,{onClick:s,children:[o.jsx(Xe,{completed:b,height:10,bgColor:g===void 0?"none":"#c0bfbf",isLabelVisible:!1,baseBgColor:"",transitionDuration:f,transitionTimingFunction:"linear"}),o.jsx("div",{className:"grid",children:(()=>{if(t.length===0)return null;const d=t.map(T=>({orientation:T.orientation||"landscape"})),r=window.innerWidth,x=window.innerHeight-10,A=Ke(d,r,x),c={portrait:t.filter(T=>(T.orientation||"landscape")==="portrait"),landscape:t.filter(T=>(T.orientation||"landscape")==="landscape"),wide:t.filter(T=>T.orientation==="wide")},w={portrait:0,landscape:0,wide:0};return A.videos.map((T,j)=>{const L=T.orientation,N=w[L],k=c[L][N];if(!k)return null;w[L]++;const P=y[k.entity_id]||null,v=ro(k.entity_id,P,e.HASS_HOST);return v?o.jsxs("div",{className:"video-container",style:{left:`${T.x}px`,top:`${T.y}px`,width:`${T.width}px`,height:`${T.height}px`},children:[o.jsx("img",{src:v,className:L,alt:"Camera stream",crossOrigin:"anonymous"},`${k.entity_id}-${j}`),o.jsx("div",{className:"video-overlay",onClick:()=>s()})]},`${L}-${N}-${j}`):null})})()}),h==="confirm"&&o.jsx("div",{className:"open-door confirm",children:"Haustür öffnen?"}),h==="opening"&&o.jsx("div",{className:"open-door opening",children:"Öffne die Tür!"})]})})]})},co=O.div`
  display: flex;
...
`,To=()=>{const[e,i]=_.useState(void 0),[t,n]=yo(e),{nextWeek:a,previousWeek:u,startWeekWithToday:g}=Ao(i);_.useEffect(()=>{g()},[]);const p=bo({onSwipedLeft:()=>a(),onSwipedRight:()=>u()}),b=C.useMemo(()=>({weekday:"short",month:"numeric",day:"numeric"}),[]),l=C.useMemo(()=>t.slice(0,7),[t]);return o.jsxs(So,{...p,children:[o.jsx(fo,{nextWeek:a,previousWeek:u,startWeekWithToday:g}),o.jsxs("div",{className:"schedule",children:[l.map((f,E)=>o.jsx("div",{className:Y({weekend:we(f.date),today:Ae(f.date)},"caption"),children:o.jsx("h2",{children:f.date.toLocaleString(b)})},E)),l.map((f,E)=>o.jsx("div",{className:Y("allDayRow",{weekend:we(f.date),today:Ae(f.date)}),children:f.allDay.map((S,y)=>o.jsx("div",{className:"allDayEvent",children:S.summary},y))},E)),l.map((f,E)=>o.jsx("div",{className:Y("eventRow",{weekend:we(f.date),today:Ae(f.date)}),children:f.events.map((S,y)=>o.jsxs("div",{className:"event",children:[o.jsx("div",{children:S.summary}),o.jsxs("h3",{children:[S.icon&&o.jsx(G,{path:S.icon,size:"1rem",color:"#ffffff"}),ve(S.start.dateTime)," - ",ve(S.end.dateTime)]})]},y))},E))]}),t.length===0&&o.jsx("div",{className:"loading",children:n!==!1?o.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[o.jsx("h3",{children:"Fehler beim Laden der Kalenderdaten"}),o.jsx("div",{children:n instanceof Error?n.message:String(n)})]}):o.jsx(Fe,{visible:!0,height:"80",width:"80",color:"#c1c1c1",radius:"9",ariaLabel:"three-dots-loading",wrapperStyle:{},wrapperClass:""})}),n!==!1&&t.length>0&&o.jsx("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center",marginTop:"1rem"},children:o.jsxs("div",{children:["Warnung: ",n instanceof Error?n.message:String(n)]})})]})},ge={"clear-day":{icon:st,label:"Klar",color:"#eeeef5"},"clear-night":{icon:rt,label:"Klar",color:"#eeeef5"},rain:{icon:it,label:"Regen",color:"#80a5d6"},snow:{icon:nt,label:"Schnee",color:"#8c82ce"},sleet:{icon:ot,label:"Graupel",color:"#aba4db"},wind:{icon:tt,label:"Stürmisch",color:"#9fb6d6"},fog:{icon:et,label:"Neblig",color:"#d5dae2"},cloudy:{icon:Ze,label:"Bewölkt",color:"#b6bfcb"},"partly-cloudy-day":{icon:Qe,label:"Teils bewölkt",color:"#d5dae2"},"partly-cloudy-night":{icon:Je,label:"Teils bewölkt",color:"#d5dae2"}},_o=e=>{const[i,t]=_.useState([]),[n,a]=_.useState(!1),u=Re(6e4*10,"Weather"),g=V(),p=g.ENABLE_WEATHER||!1,b=g.WEATHER_API_KEY||"",l=g.WEATHER_LATITUDE,f=g.WEATHER_LONGITUDE,E=p&&b&&l&&f,S=()=>`./forecast/${b}/${l},${f}?&units=si&exclude=minutely`;return _.useEffect(()=>{E&&I(S()).then(y=>{t(y.data),a(!1)}).catch(y=>{a(z(y))}).finally(()=>{})},[u,e,E,p,b,l,f]),[i,n]},Lo=ct(lt),Ie=O.div`
...
`,Pe=C.memo(({data:e,daily:i=!1})=>o.jsxs("div",{children:[o.jsxs("div",{children:[!i&&B.fromSeconds(e.time).toLocaleString(B.TIME_24_SIMPLE),i&&B.fromSeconds(e.time).setLocale("de").toFormat("ccc, d.M")]}),o.jsx("div",{children:o.jsx(Se,{icon:e.icon})}),o.jsx("div",{children:o.jsxs("strong",{children:[!i&&o.jsxs(o.Fragment,{children:[Math.round(e.temperature),"°"]}),i&&o.jsxs(o.Fragment,{children:[Math.round(e.temperatureHigh),"° / ",Math.round(e.temperatureLow),"°"]})]})}),o.jsxs("div",{children:[Math.round(e.precipProbability*100)," %"]}),o.jsxs("div",{children:[(e.precipIntensity*100).toFixed(1)," mm"]})]})),Ro=e=>!e||!e.hourly||!e.hourly.data?[]:e.hourly.data.slice(0,24).map(i=>({color:ge[i.icon]?.color||"#ffffff",text:ge[i.icon]?.label||"",annotation:`${Math.round(i.temperature)}°`,time:i.time})),Se=({icon:e})=>{const i=ge[e];return o.jsx(i.icon,{size:60,color:"#ffffff"})},jo=()=>{if(!(V().ENABLE_WEATHER||!1))return null;const[t,n]=_o(),[a,u]=_.useState(!1),g=re("w"),p=_.useRef(),b=C.useCallback(()=>u(y=>!y),[]),l=C.useCallback(()=>u(!0),[]),f=C.useMemo(()=>Ro(t),[t]),E=C.useMemo(()=>[3,6,9,12],[]),S=C.useMemo(()=>[1,2,3,4,5,6,7],[]);return _.useEffect(()=>{if(!a||!p.current||!t||!t.hourly||f.length===0)return;const y={timezone:"Europe/Berlin"},h=document.createElement("div");return p.current.textContent="",p.current.appendChild(h),Wt(h,f,y),()=>{p.current&&(p.current.textContent="")}},[a,f]),_.useEffect(()=>{g&&b()},[g]),!t||!("currently"in t)||!("daily"in t)||!("hourly"in t)?n!==!1?o.jsx(Ie,{children:o.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[o.jsx("h3",{children:"Fehler beim Laden der Wetterdaten"}),o.jsx("div",{children:n instanceof Error?n.message:String(n)})]})}):"":o.jsxs(Ie,{children:[o.jsxs("div",{onClick:l,children:[o.jsxs("div",{className:"headline",children:[o.jsx(Se,{icon:t.currently.icon}),o.jsxs("h2",{children:[Math.round(t.currently.temperature),"°"]})]}),o.jsx("div",{className:"forecast",children:E.map((y,h)=>o.jsx(Pe,{data:t.hourly.data[y]},h))})]}),o.jsx(ce,{visible:a,onClick:b,children:o.jsxs("div",{className:"full-weather",children:[n!==!1&&o.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center",marginBottom:"1rem"},children:[o.jsx("h3",{children:"Fehler!"}),o.jsx("div",{children:n instanceof Error?n.message:String(n)})]}),o.jsxs("div",{className:"detail-header",children:[o.jsx("div",{children:o.jsxs("div",{className:"headline",children:[o.jsx(Se,{icon:t.daily.data[0].icon}),o.jsxs("h2",{children:[Math.round(t.daily.data[0].temperatureHigh),"° /",o.jsxs("span",{children:[Math.round(t.daily.data[0].temperatureLow),"°"]})]})]})}),o.jsx("h3",{children:ge[t.daily.data[0].icon].label})]}),o.jsx("div",{className:"values",children:o.jsxs("div",{className:"table",children:[o.jsxs("div",{children:[o.jsx("span",{children:"Gefühlt:"})," ",Math.round(t.daily.data[0].apparentTemperatureHigh),"° C"]}),o.jsxs("div",{children:[o.jsx("span",{children:"Luftfeuchtigkeit:"})," ",Math.round(t.daily.data[0].humidity*100)," %"]}),o.jsxs("div",{children:[o.jsx("span",{children:"Wind:"})," ",Math.round(t.daily.data[0].windSpeed)," km/h"]}),o.jsxs("div",{children:[o.jsx("span",{children:"Bewölkung:"})," ",Math.round(t.daily.data[0].cloudCover*100)," %"]}),o.jsxs("div",{children:[o.jsx("span",{children:"Regen:"})," ",t.daily.data[0].precipProbability*100," %"]}),o.jsxs("div",{children:[o.jsx("span",{children:"UV Index:"})," ",t.daily.data[0].uvIndex]}),o.jsxs("div",{children:[o.jsx("span",{children:"Luftdruck:"})," ",Math.round(t.daily.data[0].pressure)]})]})}),o.jsx("h3",{children:"Die nächsten 24 Stunden"}),o.jsx("div",{ref:p}),o.jsx("h3",{children:"Die nächste Woche"}),o.jsx("div",{className:"forecast",children:S.map((y,h)=>o.jsx(Pe,{data:t.daily.data[y],daily:!0},h))}),o.jsxs("div",{className:"info",children:["Aktualisiert ",o.jsx(at,{date:B.fromSeconds(t.currently.time).toJSDate(),formatter:Lo})]})]})})]})},No=C.memo(jo),Co="AK Wandsbek",ko="Hamburg",Oo="Master:62016",Do="STATION",vo={x:10.091341,y:53.568702},Io={name:Co,city:ko,id:Oo,type:Do,coordinate:vo},pe={departureList:"departureList",checkName:"checkName"},Po=async(e,i)=>I({method:"post",url:`./gti/public/${e}`,data:i,headers:{Accept:"application/json","Content-Type":"application/json;charset=UTF-8"}}),We=(e,i)=>e.realtimeOffset-i.realtimeOffset,Wo=e=>{const i=e.departures.map(t=>({line:t.line.name,direction:t.line.direction,timeOffset:t.timeOffset,delay:t.delay?t.delay:"0",directionId:t.directionId,realtimeOffset:t.timeOffset+(t.delay?t.delay:0)/60}));return{from:i.filter(t=>t.directionId===1).slice(0,3).sort(We),to:i.filter(t=>t.directionId===6).slice(0,3).sort(We)}},Mo=e=>{const t=V().ENABLE_HVV||!1,[n,a]=_.useState([]),[u,g]=_.useState(!1),p=Re(6e4),b=t;return _.useEffect(()=>{if(!b)return;if(!(e in pe)){R.warn(e,"not supported by HVV connector");return}let l={version:51};switch(e){case pe.checkName:l={...l,theName:{name:"AK Wandsbek",type:"STATION"},maxList:1};break;case pe.departureList:const f=B.now();l={...l,station:Io,time:{date:f.toFormat("dd.MM.yyyy"),time:f.toFormat("HH:mm")},maxList:20,maxTimeOffset:200,useRealtime:!0};break;default:l=void 0}Po(e,l).then(f=>{a(Wo(f.data)),g(!1)}).catch(f=>{g(z(f))})},[e,p,b,t]),[n,u]},$o=O.div`
  margin-top: 2rem;
...
`,Me=C.memo(({line:e,direction:i,realtimeOffset:t})=>o.jsxs("div",{className:"departure",children:[o.jsx("div",{children:o.jsx("img",{src:`https://cloud.geofox.de/icon/linename?name=${e}&outlined=true&fileFormat=SVG&height=14&appearance=COLOURED`,alt:`Linie ${e}`})}),o.jsx("div",{children:t===0?"Jetzt":o.jsxs(o.Fragment,{children:["in ",t," '"]})})]})),Vo=()=>{if(!(V().ENABLE_HVV||!1))return null;const[t,n]=Mo(pe.departureList);return o.jsx($o,{children:n!==!1?o.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[o.jsx("h3",{children:"Fehler!"}),o.jsx("div",{children:n instanceof Error?n.message:String(n)})]}):o.jsxs(o.Fragment,{children:[o.jsx("h3",{children:"→ Wandsbek"}),t.to?.map((a,u)=>o.jsx(Me,{line:a.line,direction:a.direction,realtimeOffset:a.realtimeOffset},u)),o.jsx("h3",{children:"→ Stadtauswärts"}),t.from?.map((a,u)=>o.jsx(Me,{line:a.line,direction:a.direction,realtimeOffset:a.realtimeOffset},u))]})})},Bo=C.memo(Vo),Yo=()=>{const e=V(),i=e.ENABLE_EV||!1,t=e.ENTITY_PRECLIMATE_STATUS||"";e.ENTITY_PRECLIMATE_START,e.ENTITY_PRECLIMATE_STOP;const n=e.ENTITY_CHARGING_STATE||"",a=e.ENTITY_STATE_OF_CHARGE||"",u=e.HASS_ACCESS_TOKEN||"",g=e.SUPERVISOR_TOKEN||"",[p,b]=_.useState({preclimateStatus:!1,chargingState:!1,stateOfCharge:0}),[l,f]=_.useState(!1),E=i&&(t||n||a);return _.useEffect(()=>{if(!E)return;(async()=>{const y=[];t&&y.push(I(M(`/api/states/${t}`)).then(s=>({type:"preclimateStatus",value:s.data.state==="on"})).catch(s=>({type:"preclimateStatus",error:z(s)}))),n&&y.push(I(M(`/api/states/${n}`)).then(s=>({type:"chargingState",value:s.data.state==="on"})).catch(s=>({type:"chargingState",error:z(s)}))),a&&y.push(I(M(`/api/states/${a}`)).then(s=>({type:"stateOfCharge",value:parseFloat(s.data.state)||0})).catch(s=>({type:"stateOfCharge",error:z(s)})));const h=await Promise.all(y);let m=!1;h.forEach(s=>{s.error?m=s.error:b(d=>({...d,[s.type]:s.value}))}),f(m||!1)})()},[E,i,t,n,a]),_.useEffect(()=>{let S=null,y=[],h=!0,m=null,s=0,d=!1;async function r(){if(!E||d)return;if(S){try{y.forEach(w=>{w&&w()}),y=[],S.close()}catch(w){R.debug("Error closing existing WebSocket connection:",w)}S=null}d=!0;const x=le(),A=g||u||"";if(!A){R.debug("Skipping WebSocket connection - no access token (using REST API only)"),d=!1;return}let c;try{c=se(x,A),h&&f(!1)}catch(w){h&&(R.error("Failed to create WebSocket auth:",w),f(w instanceof Error?w.message:String(w))),d=!1;return}try{S=await ae({auth:c}),S.addEventListener("ready",()=>{h&&(R.debug("WebSocket connection ready for EV entities"),s=0,f(!1))}),S.addEventListener("disconnected",()=>{if(h&&!d){R.debug("WebSocket disconnected for EV entities, will attempt to reconnect"),m&&clearTimeout(m),S=null,y=[];const j=Math.min(1e3*Math.pow(2,s),3e4);s++,m=setTimeout(()=>{h&&!d&&(R.debug(`Attempting to reconnect WebSocket for EV entities (attempt ${s})`),r())},j)}});const w=j=>{if(h){const L=j.variables.trigger.to_state.entity_id,N=j.variables.trigger.to_state.state;b(k=>{const P={...k};return L===t?P.preclimateStatus=N==="on":L===n?P.chargingState=N==="on":L===a&&(P.stateOfCharge=parseFloat(N)||0),P})}},T=[];t&&T.push(t),n&&T.push(n),a&&T.push(a);for(const j of T){const L=await S.subscribeMessage(w,{type:"subscribe_trigger",trigger:{platform:"state",entity_id:j}});y.push(L)}d=!1}catch(w){if(d=!1,h){R.error("Failed to setup WebSocket connection:",w),f(w instanceof Error?w.message:String(w));const T=Math.min(1e3*Math.pow(2,s),3e4);s++,m=setTimeout(()=>{h&&(R.debug(`Attempting to reconnect WebSocket for EV entities after error (attempt ${s})`),r())},T)}}}return r(),()=>{h=!1,m&&clearTimeout(m),y.forEach(x=>{x&&x()}),S&&S.close()}},[E,i,t,n,a,u,g]),[p,l]},Ho=e=>{const i=e?.ENTITY_PRECLIMATE_START||"";i&&I.post(M("/api/services/button/press"),{entity_id:i}).catch(t=>{R.error("Failed to start preclimate:",t)})},Fo=e=>{const i=e?.ENTITY_PRECLIMATE_STOP||"";i&&I.post(M("/api/services/button/press"),{entity_id:i}).catch(t=>{R.error("Failed to stop preclimate:",t)})},Go=O.div`
  padding-bottom: 12px;
...
`,Uo=(e,i)=>i?St:e>=80?Tt:e>=50?_t:e>=20?Lt:Rt,zo=e=>e>=90?"#17e146":e>=40?"#ff9800":"#f85a5a",Ko=()=>{const e=V();if(!(e.ENABLE_EV||!1))return null;const[t,n]=Yo(),{preclimateStatus:a,chargingState:u,stateOfCharge:g}=t,[p,b]=C.useState(!1),[l,f]=C.useState(null),[E,S]=C.useState(!1),[y,h]=C.useState(!1),[m,s]=C.useState(0),d=C.useRef(null),r=C.useRef(null),x=C.useRef(a),A=C.useRef(null);C.useEffect(()=>{x.current!==a&&(p&&A.current!==null&&a===(l==="start")&&(s(l==="start"?360:0),h(!0),setTimeout(()=>{b(!1),f(null),h(!1),s(0),A.current=null,S(!1)},300),d.current&&(clearTimeout(d.current),d.current=null)),x.current=a)},[a,p,l]),C.useEffect(()=>{if(!p||y){r.current&&(cancelAnimationFrame(r.current),r.current=null);return}const P=A.current||Date.now(),v=1e4,H=l==="stop",$=()=>{const F=Date.now()-P,U=Math.min(F/v,1);s(H?360*(1-U):360*U),U<1&&!y&&(r.current=requestAnimationFrame($))};return r.current=requestAnimationFrame($),()=>{r.current&&(cancelAnimationFrame(r.current),r.current=null)}},[p,y,l]),C.useEffect(()=>()=>{d.current&&clearTimeout(d.current),r.current&&cancelAnimationFrame(r.current)},[]);const c=C.useCallback(()=>{if(n!==!1||p)return;const P=!a,v=P?"start":"stop";b(!0),f(v),h(!1),S(!1),s(0),A.current=Date.now(),x.current=a,P?Ho(e):Fo(e),d.current=setTimeout(()=>{p&&(S(!0),setTimeout(()=>{b(!1),f(null),h(!1),s(0),S(!1),A.current=null},500))},15e3)},[a,n,p]),w=Uo(g||0,u),T=zo(g||0),j=Math.round(g||0),L=p?l==="start":a,N=l==="start"?"#17e146":"#f85a5a",k=l==="start"?"clockwise":"counterclockwise";return o.jsxs(Go,{className:Y({disabled:n!==!1}),children:[o.jsxs("h2",{children:["Auto",n!==!1?o.jsxs("div",{className:"battery-info",children:[o.jsx(G,{path:_e,size:"1.2rem",color:"#f85a5a"}),o.jsx("span",{children:"Fehler"})]}):o.jsxs("div",{className:"battery-info",children:[o.jsxs("span",{className:"charge-percentage",children:[j,"%"]}),o.jsx(G,{path:w,size:"1.2rem",color:T})]})]}),n===!1&&o.jsxs("div",{className:"preclimate-button-wrapper",children:[p&&o.jsx("div",{className:Y("progress-ring",k,{complete:y}),style:{"--progress-color":N,"--progress-angle":`${m}deg`,"--progress-gradient":l==="stop"?`conic-gradient(from -90deg, ${N} 0deg, ${N} ${m}deg, transparent ${m}deg, transparent 360deg)`:`conic-gradient(from -90deg, ${N} 0deg, ${N} ${m}deg, transparent ${m}deg, transparent 360deg)`}}),o.jsxs("button",{className:Y("preclimate-button",{spinning:L&&!p,shaking:E}),onClick:c,disabled:n!==!1||p,children:[o.jsx(G,{path:bt,size:"2rem",color:L?"#ff9800":"#ffffff"}),o.jsx("span",{children:L?"Stop":"Start"})]})]})]})},qo=C.memo(Ko),Xo=()=>{const e=V(),i=e.ENABLE_GARAGE||!1,t=e.ENTITY_GARAGE_DOOR||"",n=e.HASS_ACCESS_TOKEN||"",a=e.SUPERVISOR_TOKEN||"",[u,g]=_.useState("closed"),[p,b]=_.useState(!1),l=i&&t,f=t?M(`/api/states/${t}`):null;return _.useEffect(()=>{!l||!f||I(f).then(E=>{g(E.data.state),b(!1)}).catch(E=>{b(z(E))})},[l,f,i,t]),_.useEffect(()=>{let E=null,S=null,y=!0,h=null,m=0,s=!1;async function d(){if(!l||!t||s)return;if(E){try{S&&(S(),S=null),E.close()}catch(c){R.debug("Error closing existing WebSocket connection:",c)}E=null}s=!0;const r=le(),x=a||n||"";if(!x){R.debug("Skipping WebSocket connection - no access token (using REST API only)"),s=!1;return}let A;try{A=se(r,x),y&&b(!1)}catch(c){y&&(R.error("Failed to create WebSocket auth:",c),b(c instanceof Error?c.message:String(c))),s=!1;return}try{E=await ae({auth:A}),E.addEventListener("ready",()=>{y&&(R.debug("WebSocket connection ready for garage door"),m=0,b(!1))}),E.addEventListener("disconnected",()=>{if(y&&!s){R.debug("WebSocket disconnected for garage door, will attempt to reconnect"),h&&clearTimeout(h),E=null,S=null;const w=Math.min(1e3*Math.pow(2,m),3e4);m++,h=setTimeout(()=>{y&&!s&&(R.debug(`Attempting to reconnect WebSocket for garage door (attempt ${m})`),d())},w)}});const c=w=>{y&&g(w.variables.trigger.to_state.state)};S=await E.subscribeMessage(c,{type:"subscribe_trigger",trigger:{platform:"state",entity_id:t}}),s=!1}catch(c){if(s=!1,y){R.error("Failed to setup WebSocket connection:",c),b(c instanceof Error?c.message:String(c));const w=Math.min(1e3*Math.pow(2,m),3e4);m++,h=setTimeout(()=>{y&&(R.debug(`Attempting to reconnect WebSocket for garage door after error (attempt ${m})`),d())},w)}}}return d(),()=>{y=!1,h&&clearTimeout(h),S&&S(),E&&E.close()}},[l]),[u,p]},Jo=e=>{if(!ENTITY_GARAGE_DOOR)return;e(!0);const i=setTimeout(()=>e(!1),3e3);I.post(M("/api/services/cover/toggle"),{entity_id:ENTITY_GARAGE_DOOR}).catch(t=>{R.error("Failed to toggle garage door:",t)}).finally(()=>{clearTimeout(i),e(!1)})},Qo=e=>{if(!ENTITY_GARAGE_DOOR)return;e(!0);const i=setTimeout(()=>e(!1),3e3);I.post(M("/api/services/cover/open_cover"),{entity_id:ENTITY_GARAGE_DOOR}).catch(t=>{R.error("Failed to open garage door:",t)}).finally(()=>{clearTimeout(i),e(!1)})},Zo=e=>{if(!ENTITY_GARAGE_DOOR)return;e(!0);const i=setTimeout(()=>e(!1),3e3);I.post(M("/api/services/cover/close_cover"),{entity_id:ENTITY_GARAGE_DOOR}).catch(t=>{R.error("Failed to close garage door:",t)}).finally(()=>{clearTimeout(i),e(!1)})},en=O.div`
  padding-bottom: 12px;
...
`,Te=e=>{const i={unknown:{label:"In Bewegung oder halb-offen",icon:Ot},open:{label:"Offen",icon:kt},closed:{label:"Geschlossen",icon:Ct},opening:{label:"Öffnet",icon:Nt},closing:{label:"Schließt",icon:jt}};return i[e]||R.warn("Garage door state is not recognized:",e,"Available states: unknown, open, closed, opening, closing"),i[e]||{label:"Unavailable",icon:Dt}},tn=({garageDoor:e,animate:i=!1})=>o.jsxs(qe,{className:Y({animate:i}),children:[o.jsx(G,{path:Te(e).icon,size:"2rem",color:"#ffffff"}),o.jsx("span",{children:Te(e).label})]}),on=e=>dt.promise(e,{pending:"Garagentor ist in Bewegung …",success:{render({data:i}){return Te(i).label}},error:"Nope"},{position:"bottom-center",autoClose:5e3,hideProgressBar:!1,closeOnClick:!1,pauseOnHover:!1,draggable:!1,progress:void 0,theme:"dark",transition:void 0}),nn=()=>{if(!(V().ENABLE_GARAGE||!1))return null;const[t,n]=Xo(),[a,u]=_.useState(void 0),[g,p]=_.useState(!1),[b,l]=_.useState(!1);_.useEffect(()=>{if(t==="unknown"||t==="opening"||t==="closing"){if(!a){const h=new Promise(m=>{u({resolve:m})});on(h)}}else a&&(a.resolve(t),u(void 0))},[t]);const f=re("g");_.useEffect(()=>{f&&n===!1&&Jo(p)},[f,n]);const E=C.useCallback(y=>{if(n===!1)switch(l(!1),y){case"open":Qo(p);break;case"close":Zo(p);break}},[p,n]),S=C.useCallback(()=>{n===!1&&l(!0)},[n]);return o.jsxs(en,{className:Y({disabled:n!==!1}),children:[o.jsx("h2",{children:"Garage"}),o.jsx("div",{className:"status",onClick:S,children:n!==!1?o.jsxs(qe,{children:[o.jsx(G,{path:_e,size:"2rem",color:"#f85a5a"}),o.jsx("span",{children:"Fehler"})]}):o.jsx(tn,{garageDoor:t,animate:g})}),o.jsx(ce,{visible:b&&n===!1,onClick:()=>l(!1),children:o.jsxs("div",{className:"controls",children:[o.jsx("h2",{children:"Garagentor"}),o.jsx("div",{onClick:()=>E("open"),children:"Öffnen"}),o.jsx("div",{onClick:()=>E("close"),children:"Schließen"})]})})]})},rn=C.memo(nn),sn=e=>e?M(`/api/states/${e}`):null,q={done:{label:"Fertig",animate:!1,icon:It},off:{label:"Aus",animate:!1,icon:vt},standby:{label:"Standby",animate:!1,icon:je},running:{label:"Läuft …",animate:!0,icon:je}},an={off:0,standby:2,running:16,done:256},cn=()=>{const e=V();e.ENABLE_LAUNDRY;const i=e.LAUNDRY_MACHINES||[];e.HASS_ACCESS_TOKEN,e.SUPERVISOR_TOKEN;const n=(Array.isArray(i)?i:[]).map((E,S)=>{const[y,h]=ln(E.entity_id);return{state:y,error:h,name:E.name}}),[a,u]=_.useState(q.off),[g,p]=_.useState(!1),b=n.map(E=>E.state),l=n.map(E=>E.error);_.useEffect(()=>{const E=l.some(S=>S!==!1);p(E&&l.find(S=>S!==!1)||!1)},[l]),_.useEffect(()=>{const E=b.reduce((S,y)=>S+(an[y]||0),0);E===0?u(q.off):E<16?u(q.standby):E<256?u(q.running):E%256===0?u(q.done):E%256%16===0?u(q.running):E%256%2===0?u(q.done):u(q.running)},[b]);const f=n.map(E=>({label:E.name,state:E.state}));return[a,f,g]},ln=e=>{const[i,t]=_.useState("off"),[n,a]=_.useState(!1),u=ENABLE_LAUNDRY&&e,g=sn(e);return _.useEffect(()=>{!u||!g||I(g).then(p=>{t(p.data.state),a(!1)}).catch(p=>{a(z(p))})},[e,u,g]),_.useEffect(()=>{let p=null,b=null,l=!0,f=null,E=0,S=!1;async function y(){if(!u||!e||S)return;if(p){try{b&&(b(),b=null),p.close()}catch(s){R.debug(`Error closing existing WebSocket connection for ${e}:`,s)}p=null}S=!0;const h=le(),m=SUPERVISOR_TOKEN||HASS_ACCESS_TOKEN||"";if(!m){R.debug("Skipping WebSocket connection - no access token (using REST API only)"),S=!1;return}try{const s=se(h,m);p=await ae({auth:s}),p.addEventListener("ready",()=>{l&&(R.debug(`WebSocket connection ready for ${e}`),E=0,a(!1))}),p.addEventListener("disconnected",()=>{if(l&&!S){R.debug(`WebSocket disconnected for ${e}, will attempt to reconnect`),f&&clearTimeout(f),p=null,b=null;const r=Math.min(1e3*Math.pow(2,E),3e4);E++,f=setTimeout(()=>{l&&!S&&(R.debug(`Attempting to reconnect WebSocket for ${e} (attempt ${E})`),y())},r)}});const d=r=>{l&&t(r.variables.trigger.to_state.state)};b=await p.subscribeMessage(d,{type:"subscribe_trigger",trigger:{platform:"state",entity_id:e}}),S=!1}catch(s){if(S=!1,l){R.error(`Failed to setup WebSocket connection for ${e}:`,s),a(s instanceof Error?s.message:String(s));const d=Math.min(1e3*Math.pow(2,E),3e4);E++,f=setTimeout(()=>{l&&(R.debug(`Attempting to reconnect WebSocket for ${e} after error (attempt ${E})`),y())},d)}}}return y(),()=>{l=!1,f&&clearTimeout(f),b&&b(),p&&p.close()}},[e,u]),[i,n]},dn=O.div`
  padding-bottom: 12px;
...
`,fn=()=>{if(!(V().ENABLE_LAUNDRY||!1))return null;const[t,n,a]=cn(),[u,g]=_.useState(!1),p=C.useCallback(()=>{a===!1&&g(!0)},[a]),b=C.useCallback(()=>g(!1),[]);return o.jsxs(dn,{className:Y({disabled:a!==!1}),children:[o.jsx("h2",{children:"Wäsche"}),o.jsx("div",{className:"status",onClick:p,children:a!==!1?o.jsxs(o.Fragment,{children:[o.jsx(G,{path:_e,size:"2rem",color:"#f85a5a"}),o.jsx("span",{children:"Fehler"})]}):o.jsxs(o.Fragment,{children:[o.jsx("div",{className:Y({animate:t.animate}),children:o.jsx(G,{path:t.icon,size:"2rem",color:"#ffffff"})}),o.jsx("span",{children:t.label})]})}),o.jsx(ce,{visible:u&&a===!1,onClick:b,children:o.jsxs("div",{className:"states",children:[o.jsx("h2",{children:"Wäsche"}),n.map((l,f)=>o.jsxs("div",{children:[o.jsx("div",{className:"subtitle",children:l.label}),o.jsx("div",{className:Y({animate:q[l.state].animate}),children:o.jsx(G,{path:q[l.state].icon,size:2})}),o.jsx("div",{children:q[l.state].label})]},f))]})})]})},un=C.memo(fn),hn=O.div`
  padding: 0 0 0 24px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`;function vn(){return Cn(),o.jsxs(Dn,{children:[o.jsx(On,{}),o.jsxs("div",{className:"main",children:[o.jsx(xe,{children:o.jsx(To,{})}),o.jsx(xe,{children:o.jsx(mn,{})})]}),o.jsx(ht,{autoClose:5e3,hideProgressBar:!1,closeOnClick:!1,pauseOnHover:!1,draggable:!1,theme:"dark"})]})}function In(){return o.jsx(xe,{children:o.jsxs(ut,{children:[o.jsx(ye,{path:"/demo",element:o.jsx(He,{})}),o.jsx(ye,{path:"/tiling-demo",element:o.jsx(He,{})}),o.jsx(ye,{path:"*",element:o.jsx(vn,{})})]})})}const Pn=pt.createRoot(document.getElementById("root"));Pn.render(o.jsx(_.StrictMode,{children:o.jsx(xe,{children:o.jsx(Bt,{children:o.jsx(mt,{children:o.jsx(In,{})})})})}));
