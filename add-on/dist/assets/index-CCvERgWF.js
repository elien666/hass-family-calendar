...
`,In=({on:e,month:n,day:t})=>{const[o,i]=e,c=o.indexOf(`${n}-${t}`),a=c>-1,m=()=>{i(a?o.toSpliced(c,1):[...o,`${n}-${t}`])};return r.jsx("div",{className:Y("dot",{on:a}),onClick:()=>m()})},$n=()=>{const e=U();if(!(e.ENABLE_EVERYDAY_CALENDAR||!1))return null;const t=new Date().getFullYear(),o=[];for(let u=1;u<13;u++){const p=new Date(t,u,0).getDate();for(let R=1;R<=p;R++)o.push({month:u,day:R})}const i=Array.from({length:31},(u,p)=>p+1),c=Array.from({length:12},(u,p)=>p+1),a=A.useState(void 0),[m,w]=Dn();return A.useEffect(()=>{m!==null&&a[1](m)},[m]),A.useEffect(()=>{a[0]!==void 0&&vn(a[0],e)},[a[0],e]),a[0]!==void 0?r.jsxs(Ye,{children:[r.jsx("h2",{children:"Jeden Tag ein bißchen"}),w!==!1&&r.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center",marginBottom:"1rem"},children:[r.jsx("h3",{children:"Fehler!"}),r.jsx("div",{children:w instanceof Error?w.message:String(w)})]}),r.jsxs("div",{className:"calendar",children:[i.map((u,p)=>r.jsx("div",{style:{gridArea:`${u+1} / 1 / ${u+1} / 1`},children:u},p)),c.map((u,p)=>r.jsx("div",{style:{gridArea:`1 / ${u+1} / 1 / ${u+1}`},children:u},p)),o.map((u,p)=>r.jsx("div",{style:{gridArea:`${u.day+1} / ${u.month+1} / ${u.day+1} / ${u.month+1}`},children:r.jsx(In,{on:a,month:u.month,day:u.day})},p))]})]}):r.jsx(Ye,{className:"loading",children:w!==!1?r.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[r.jsx("h3",{children:"Fehler!"}),r.jsx("div",{children:w instanceof Error?w.message:String(w)})]}):r.jsx(at,{visible:!0,height:"80",width:"80",color:"#c1c1c1",radius:"9",ariaLabel:"three-dots-loading",wrapperStyle:{},wrapperClass:""})})},Mn=v.div`
  ...
  }`,Wn=()=>{const[e,n]=A.useState(F.now()),[t,o]=A.useState(!1),i=T.useCallback(()=>o(!0),[]),c=T.useCallback(()=>o(!1),[]);return A.useEffect(()=>{const a=setInterval(()=>n(F.now()),1e3);return()=>clearInterval(a)},[]),r.jsxs(r.Fragment,{children:[r.jsxs(Mn,{onClick:i,children:[e.toFormat("HH"),r.jsx("span",{children:":"}),e.toFormat("mm")]}),r.jsx(he,{visible:t,onClick:c,fullsize:!0,children:r.jsx($n,{})})]})},Pn=T.memo(Wn);function mt({onReady:e,enabled:n=!0,checkBackendConnection:t=!0,reconnectStrategy:o="simple",maxReconnectAttempts:i=5,reconnectDelay:c=2e3,logPrefix:a="WebSocket",dependencies:m=[]}){const w=U(),u=Me(),p=t?u?.isConnected:!0,[R,b]=A.useState(!1),[S,E]=A.useState(!1),x=A.useRef(null),f=A.useRef(null),h=A.useRef(!0),s=A.useRef(null),l=A.useRef(null),g=A.useRef(null),d=A.useRef(0),y=A.useRef(!1),C=A.useRef(!1),j=A.useRef(new Map),N=A.useRef(null),k=A.useRef(null),O=A.useRef(null),_=A.useRef(p);_.current=p;const D=A.useCallback(()=>{const $=x.current;if(f.current,s.current&&(clearTimeout(s.current),s.current=null),l.current&&(clearTimeout(l.current),l.current=null),g.current&&(clearTimeout(g.current),g.current=null),N.current&&(clearInterval(N.current),N.current=null),k.current&&(clearTimeout(k.current),k.current=null),$&&$.readyState===WebSocket.OPEN&&(j.current.forEach((P,W)=>{try{$.send(JSON.stringify({type:"unsubscribe_entity",entity_id:W}))}catch{}}),j.current.clear()),$){try{$.close()}catch{}x.current=null}f.current=null},[a]),V=A.useCallback(async()=>{if(!(!n||!h.current)&&!(t&&!_.current)&&!y.current){x.current&&D(),y.current=!0,E(!0);try{let $;if(!Tn){if($=Rn(w),!$){const W=typeof window<"u"&&window.location.protocol==="https:"?"wss:":"ws:",M=typeof window<"u"&&window.location.host?window.location.host:"";$=`${W}//${M}/api/websocket`}}if(!$){L.error(`Failed to build WebSocket URL for ${a} - cannot connect`),h.current&&b("WebSocket URL konnte nicht erstellt werden."),y.current=!1,E(!1);return}L.debug(`${a} connecting to: ${$}`);const P=new WebSocket($);x.current=P,P.onopen=()=>{if(!h.current){P.close();return}if(L.debug(`${a} connection opened`),d.current=0,C.current=!1,g.current&&(clearTimeout(g.current),g.current=null),h.current&&b(!1),y.current=!1,E(!1),e)try{const W=e(P,j);f.current=W}catch(W){L.error(`Failed to subscribe for ${a}:`,W),h.current&&b(W instanceof Error?W.message:String(W))}N.current&&clearInterval(N.current),N.current=setInterval(()=>{if(P.readyState===WebSocket.OPEN){try{P.send(JSON.stringify({type:"ping"}))}catch{return}k.current=setTimeout(()=>{L.warn(`${a} heartbeat timeout — closing stale connection`);try{P.close(4e3,"heartbeat timeout")}catch{}},dn)}},ln)},P.onmessage=W=>{try{const M=JSON.parse(W.data);if(M.type==="state_update"){const G=M.entity_id,ee=j.current.get(G);ee&&ee(M)}else if(M.type==="state_response"){const G=M.entity_id,ee=j.current.get(G);ee&&ee(M)}else M.type==="pong"?k.current&&(clearTimeout(k.current),k.current=null):M.type==="error"&&(L.error(`${a} received error:`,M.message),h.current&&b(M.message))}catch(M){L.error(`Error handling message for ${a}:`,M)}},P.onclose=W=>{if(h.current&&!y.current){L.debug(`${a} disconnected (code: ${W.code}, wasClean: ${W.wasClean})`),x.current=null,j.current.clear(),f.current=null,s.current&&(clearTimeout(s.current),s.current=null);const M=!W.wasClean&&(W.code===1006||d.current>0);if(M&&d.current>=5&&!C.current){L.warn(`Backend appears to be down for ${a} (${d.current} failed attempts), switching to periodic retry every ${Ue/1e3}s`),C.current=!0,h.current&&b("Backend nicht erreichbar. Wiederherstellungsversuche alle 60 Sekunden.");const G=()=>{g.current=setTimeout(()=>{h.current&&!y.current&&_.current&&C.current&&(L.debug(`Periodic retry attempt for ${a} (backend might be back up)`),d.current=0,O.current(),G())},Ue)};G();return}if(C.current)return;if(o==="exponential"&&d.current>=i){L.warn(`Max reconnection attempts (${i}) reached for ${a}, stopping reconnection`),h.current&&b("Verbindung verloren. Bitte Seite neu laden.");return}if(_.current)if(o==="exponential"){const G=M?c*10:c,ee=Math.min(G*Math.pow(2,d.current),6e4);d.current++,s.current=setTimeout(()=>{h.current&&!y.current&&_.current&&(L.debug(`Attempting to reconnect ${a} (attempt ${d.current}/${i})`),O.current())},ee)}else{const G=M?c*10:c;s.current=setTimeout(()=>{h.current&&!y.current&&_.current&&(L.debug(`Attempting to reconnect ${a}`),O.current())},G)}else L.debug(`Skipping reconnection for ${a} - waiting for backend connection`)}},P.onerror=W=>{L.error(`WebSocket error for ${a}:`,W),y.current=!1,E(!1),h.current&&b("WebSocket-Verbindungsfehler")}}catch($){if(y.current=!1,E(!1),h.current&&(L.error(`Failed to setup ${a} connection:`,$),b($ instanceof Error?$.message:String($)),_.current))if(o==="exponential"&&d.current<i){const P=Math.min(c*Math.pow(2,d.current),3e4);d.current++,s.current=setTimeout(()=>{h.current&&!y.current&&_.current&&(L.debug(`Attempting to reconnect ${a} after error (attempt ${d.current}/${i})`),O.current())},P)}else o==="simple"?s.current=setTimeout(()=>{h.current&&!y.current&&_.current&&O.current()},c):(L.warn(`Max reconnection attempts (${i}) reached for ${a}, stopping reconnection`),h.current&&b("Verbindung fehlgeschlagen. Bitte Seite neu laden."))}}},[n,t,w,o,i,c,a,e,D]);return O.current=V,A.useEffect(()=>{n&&p&&!x.current&&!y.current&&V()},[n,p,V,...m]),A.useEffect(()=>{n&&p&&!x.current&&!y.current&&(l.current&&(clearTimeout(l.current),l.current=null),l.current=setTimeout(()=>{h.current&&_.current&&!x.current&&!y.current&&(C.current=!1,d.current=0,g.current&&(clearTimeout(g.current),g.current=null),V())},un))},[n,p,V,a]),A.useEffect(()=>()=>{h.current=!1,D()},[D]),{connection:x.current,error:R,isConnecting:S}}const ue=({entityId:e,enabled:n,onStateUpdate:t,logPrefix:o,wsOptions:i={}})=>{const{error:c}=mt({enabled:n&&!!e,logPrefix:o,...i,onReady:(a,m)=>{const w=u=>{u.state!==void 0&&t(u.state)};return m.current.set(e,w),a.readyState===WebSocket.OPEN&&(a.send(JSON.stringify({type:"subscribe_entity",entity_id:e})),L.debug(`Subscribed to ${o} state changes`)),()=>{m.current.delete(e),a.readyState===WebSocket.OPEN&&a.send(JSON.stringify({type:"unsubscribe_entity",entity_id:e}))}},dependencies:[n,e]});return{error:c}},Bn=()=>{const e=U(),n=e.ENABLE_DOORBELL||!1,t=e.ENTITY_DOORBELL||"",o=n&&t,[i,c,a]=se({entityId:t,enabled:o,config:e,initialState:"off"}),{error:m}=ue({entityId:t,enabled:o,onStateUpdate:a,logPrefix:"doorbell"});return[i,c||m||!1]},Vn=(e={})=>{const n=e.ENTITY_DOORBELL_BUTTON||"";n&&B.post(H("/api/services/button/press",e),{entity_id:n}).catch(t=>{L.error("Failed to unlatch front door:",t)})},Un=async(e,n,t)=>{const o=H(`/api/states/${e}`,n),i=await B(o,{timeout:1e4,signal:t}),c=i.data?.attributes?.access_token||null;if(!c){const a=i.data?.state||"unknown",m=Object.keys(i.data?.attributes||{});L.warn(`Camera entity ${e} has no access_token attribute. State: ${a}, attributes: [${m.join(", ")}]`)}return{entityId:e,accessToken:c,error:c?null:`Kein access_token für ${e}`}},Fn=e=>new Promise(n=>setTimeout(n,e)),He=async(e,n,t)=>{if(!e||e.length===0)return{tokens:{},error:null};const o=t?null:new AbortController,i=t||o.signal,c=3;try{const a=e.map(async p=>{let R=null,b=null;for(let E=0;E<c;E++)try{return await Un(p,n,i)}catch(x){if(R=x,i.aborted)return{entityId:p,accessToken:null,error:"Abgebrochen"};const f=x.response?.status,h=x.code==="ECONNABORTED"||x.code==="ERR_NETWORK"||x.message?.includes("timeout"),s=f>=500,l=h||s;if(b=f?`HTTP ${f}: ${x.response?.data?.detail||x.message}`:`${x.code||"Error"}: ${x.message}`,l&&E<c-1){const g=1e3*Math.pow(2,E);L.debug(`Token fetch failed for ${p} (attempt ${E+1}): ${b}, retrying in ${g}ms...`),await Fn(g);continue}return L.error(`Failed to fetch access token for ${p} (attempt ${E+1}/${c}): ${b}`),{entityId:p,accessToken:null,error:b}}const S=R?b||R.message:"Unknown error";return L.error(`Failed to fetch access token for ${p} after ${c} attempts: ${S}`),{entityId:p,accessToken:null,error:S}}),m=await Promise.all(a),w={},u=[];if(m.forEach(({entityId:p,accessToken:R,error:b})=>{R?w[p]=R:u.push(`${p}: ${b||"Kein Token"}`)}),Object.keys(w).length===0&&u.length>0){const p=u.join(" | ");return L.error(`Camera token fetch failed for all cameras: ${p}`),{tokens:{},error:`Kamera-Token Fehler: ${p}`}}return{tokens:w,error:null}}catch(a){return i.aborted?{tokens:{},error:null}:(L.error("Failed to fetch camera access tokens:",a),{tokens:{},error:Z(a)})}},Gn=(e,n=null,t={})=>{if(!e)return null;let o;const i=t.HASS_HOST||"";if(i&&i!=="undefined"&&i!=="null")o=i.replace(/\/$/,"");else if(typeof window<"u"&&window.location)o=window.location.origin;else return null;const c=`${o}/api/camera_proxy_stream/${e}`;if(n){const a=c.includes("?")?"&":"?";return`${c}${a}token=${encodeURIComponent(n)}`}return c},I={portrait:360/480,landscape:1920/1072,wide:770/216};function zn(e){const n={landscape:0,portrait:0,wide:0};return e.forEach(t=>{t.orientation&&n.hasOwnProperty(t.orientation)&&n[t.orientation]++}),n}function xt(e,n,t){if(!e||e.length===0)return{videos:[],totalArea:0,efficiency:0};const o=e.length,i=zn(e);return o===1?Yn(e[0],n,t):o===2?Hn(i,e,n,t):o===3?Kn(i,e,n,t):o===4?qn(i,e,n,t):{videos:[],totalArea:0,efficiency:0}}function Yn(e,n,t){const o=I[e.orientation];let i,c;const a=n/t;return o>a?(i=n,c=n/o):(c=t,i=t*o),{videos:[{x:(n-i)/2,y:(t-c)/2,width:i,height:c,orientation:e.orientation}],totalArea:i*c,efficiency:i*c/(n*t)*100}}function Hn(e,n,t,o){if(e.portrait>0)return We(e,n,t,o);const i=[];e.landscape>0&&i.push("landscape"),e.wide>0&&i.push("wide");const c=i[0]||n[0].orientation,a=i[1]||n[1].orientation,m=I[c],w=I[a];if(e.landscape===1&&e.wide===1){const E=I.landscape,x=I.wide,f=t,h=f/E,s=f/x,l=h+s;let g,d,y;if(l<=o)g=h,d=s,y=f;else{const _=o/l;g=h*_,d=s*_,y=d*x}const C=(t-y)/2,N=J(n,[{x:C,y:0,width:y,height:d,orientation:"wide"},{x:C,y:d,width:y,height:g,orientation:"landscape"}]),k=y*g+y*d,O=k/(t*o)*100;return{videos:N,totalArea:k,efficiency:O}}if(e.wide===2){const E=I.wide,x=t,f=x/E,h=f*2;let s;h<=o?s=f:s=o/2;const g=J(n,[{x:0,y:0,width:x,height:s,orientation:"wide"},{x:0,y:s,width:x,height:s,orientation:"wide"}]),d=x*s*2,y=d/(t*o)*100;return{videos:g,totalArea:d,efficiency:y}}const u=[()=>{const E=t,x=E/2,f=E/2,h=x/m,s=f/w;return Math.max(h,s)<=o?{positions:[{x:0,y:(o-h)/2,width:x,height:h,orientation:c},{x,y:(o-s)/2,width:f,height:s,orientation:a}],totalArea:x*h+f*s}:null},()=>{const E=o,x=E/2,f=E/2,h=x*m,s=f*w;return Math.max(h,s)<=t?{positions:[{x:(t-h)/2,y:0,width:h,height:x,orientation:c},{x:(t-s)/2,y:x,width:s,height:f,orientation:a}],totalArea:h*x+s*f}:null}];let p=null,R=0;for(const E of u){const x=E();x&&x.totalArea>R&&(R=x.totalArea,p=x)}if(!p){const E=t/2,x=t/2,f=Math.min(E/m,o),h=Math.min(x/w,o);p={positions:[{x:0,y:(o-f)/2,width:E,height:f,orientation:c},{x:E,y:(o-h)/2,width:x,height:h,orientation:a}],totalArea:E*f+x*h}}const b=J(n,p.positions),S=p.totalArea/(t*o)*100;return{videos:b,totalArea:p.totalArea,efficiency:S}}function We(e,n,t,o){const i=e.portrait,c=n.length-i;if((i===3||i===4)&&c===0){const S=I.portrait,E=t/i,x=E/S,f=x<o?(o-x)/2:0,h=Math.min(x,o),s=[];let l=0;for(let y=0;y<i;y++){const C=Math.min(E,h*S);s.push({x:y*E+(E-C)/2,y:f,width:C,height:h,orientation:"portrait"}),l+=C*h}const g=J(n,s),d=l/(t*o)*100;return{videos:g,totalArea:l,efficiency:d}}n.filter(S=>S.orientation==="portrait");const a=n.filter(S=>S.orientation!=="portrait"),m=i>0?Math.min(t*.4,t*.5):0,w=t-m,u=[];let p=0;if(i===2&&c===0){const S=I.portrait,E=t/2,x=E/S,f=o;let h,s;x<=f?(s=x,h=E):(s=f,h=f*S);const l=(o-s)/2;u.push({x:(E-h)/2,y:l,width:h,height:s,orientation:"portrait"}),u.push({x:E+(E-h)/2,y:l,width:h,height:s,orientation:"portrait"}),p=h*s*2}else if(i===1&&c===1){const S=I.portrait,E=a[0],x=I[E.orientation],f=S+x,h=t*(S/f),s=t*(x/f),l=h/S,g=s/x,d=Math.min(o,Math.min(l,g)),y=(o-d)/2;u.push({x:0,y,width:h,height:d,orientation:"portrait"}),u.push({x:h,y,width:s,height:d,orientation:E.orientation}),p=h*d+s*d}else if(i===1&&c===2&&e.landscape===1&&e.wide===1){const S=I.portrait,E=I.wide,x=I.landscape,f=o,h=o*S,s=o/(1/E+1/x),l=s/E,g=s/x,d=h+s;if(Math.abs(d-t)<.1)u.push({x:0,y:0,width:h,height:f,orientation:"portrait"}),p+=h*f,a.find(N=>N.orientation==="wide")&&(u.push({x:0+h,y:0,width:s,height:l,orientation:"wide"}),p+=s*l),a.find(N=>N.orientation==="landscape")&&(u.push({x:0+h,y:l,width:s,height:g,orientation:"landscape"}),p+=s*g);else{const y=t/d,C=h*y,j=C/S,N=s*y,k=o/j;let O=C*k,_=o,D=N*k,V=D/E,$=D/x,P=O+D;if(P>t){const X=t/P;O=O*X,_=O/S,D=D*X,V=D/E,$=D/x,P=O+D,P>t&&(D=t-O,V=D/E,$=D/x)}const W=O+D;if(W>t){const X=t/W;O=O*X,_=O/S,D=D*X,V=D/E,$=D/x}const M=0;u.push({x:M,y:0,width:O,height:_,orientation:"portrait"}),p+=O*_,a.find(X=>X.orientation==="wide")&&(u.push({x:M+O,y:0,width:D,height:V,orientation:"wide"}),p+=D*V),a.find(X=>X.orientation==="landscape")&&(u.push({x:M+O,y:V,width:D,height:$,orientation:"landscape"}),p+=D*$)}}else if(i===1&&c===3){const S=I.portrait,E=o,x=E*S,f=x,h=t-f;u.push({x:0,y:0,width:x,height:E,orientation:"portrait"}),p+=x*E;const s=o/3;for(let l=0;l<a.length;l++){const g=a[l],d=I[g.orientation],y=s,C=h;let j,N;C/d<=y?(j=C,N=j/d):(N=y,j=N*d);const k=l*s+(s-N)/2;u.push({x:f+(h-j)/2,y:k,width:j,height:N,orientation:g.orientation}),p+=j*N}}else if(i===2&&c===1){const S=I.portrait,E=a[0],x=I[E.orientation],f=o/2,h=f*S,s=t-h,l=o*x;let g,d;l<=s?(d=o,g=d*x):(g=s,d=g/x);const y=h,C=f,j=(o-d)/2,N=(o/2-C)/2,k=o/2+(o/2-C)/2;u.push({x:0,y:j,width:g,height:d,orientation:E.orientation}),p+=g*d,u.push({x:s,y:N,width:y,height:C,orientation:"portrait"}),p+=y*C,u.push({x:s,y:k,width:y,height:C,orientation:"portrait"}),p+=y*C}else if(i===1&&c===2){const S=I.portrait,E=o,x=E*S,f=x,h=t-f;u.push({x:0,y:0,width:x,height:E,orientation:"portrait"}),p+=x*E;const s=o/2;for(let l=0;l<a.length;l++){const g=a[l],d=I[g.orientation],y=s,C=h;let j,N;C/d<=y?(j=C,N=j/d):(N=y,j=N*d);const k=l*s+(s-N)/2;u.push({x:f+(h-j)/2,y:k,width:j,height:N,orientation:g.orientation}),p+=j*N}}else{const S=i;if(S>0){const E=o/S,x=I.portrait;for(let f=0;f<S;f++){const h=Math.min(E,m/x),s=h*x,l=f*E+(E-h)/2;u.push({x:(m-s)/2,y:l,width:s,height:h,orientation:"portrait"}),p+=s*h}}if(a.length>0){const E=o/a.length;for(let x=0;x<a.length;x++){const f=a[x],h=I[f.orientation],s=E,l=w;let g,d;l/h<=s?(g=l,d=g/h):(d=s,g=d*h);const y=x*E+(E-d)/2;u.push({x:m+(w-g)/2,y,width:g,height:d,orientation:f.orientation}),p+=g*d}}}const R=J(n,u),b=p/(t*o)*100;return{videos:R,totalArea:p,efficiency:b}}function J(e,n){const t=new Array(n.length),o=new Set,i=new Set;for(let m=0;m<n.length;m++){const w=n[m];for(let u=0;u<e.length;u++)if(!o.has(u)&&e[u].orientation===w.orientation){t[m]={...w,orientation:e[u].orientation},o.add(u),i.add(m);break}}const c=[];for(let m=0;m<n.length;m++)i.has(m)||c.push(m);let a=0;for(let m=0;m<e.length;m++)if(!o.has(m)&&a<c.length){const w=c[a];t[w]={...n[w],orientation:e[m].orientation},a++}return t}function Kn(e,n,t,o){if(e.portrait>0)return We(e,n,t,o);if(e.landscape===2&&e.wide===1){const f=I.landscape,h=I.wide,s=t,l=s/h,g=o-l,d=t/2,y=d/f;let C,j,N,k;if(l<=o&&y<=g)C=s,j=l,N=d,k=y;else{const W=o/(l+y),M=Math.min(1,W);j=l*M,C=j*h,k=y*M,N=k*f}const O=(t-C)/2,_=j+(g-k)/2,V=J(n,[{x:O,y:0,width:C,height:j,orientation:"wide"},{x:0,y:_,width:N,height:k,orientation:"landscape"},{x:N,y:_,width:N,height:k,orientation:"landscape"}]),$=C*j+N*k*2,P=$/(t*o)*100;return{videos:V,totalArea:$,efficiency:P}}if(e.landscape===1&&e.wide===2){const f=I.landscape,h=I.wide,s=t/2,l=s/h,d=o-l,y=d*f;let C,j,N,k;if(l<=o&&y<=t&&l+d<=o)C=s,j=l,N=y,k=d;else{const M=l+d,G=o/M;C=s,j=l*G,k=d*G,N=k*f}const O=0,_=t/2,D=(t-N)/2,$=J(n,[{x:O,y:0,width:C,height:j,orientation:"wide"},{x:_,y:0,width:C,height:j,orientation:"wide"},{x:D,y:j,width:N,height:k,orientation:"landscape"}]),P=C*j*2+N*k,W=P/(t*o)*100;return{videos:$,totalArea:P,efficiency:W}}if(e.wide===3){const f=I.wide,h=t/2,s=h/f,g=o-s,d=g*f;let y,C,j,N;if(s<=o&&d<=t&&s+g<=o)y=h,C=s,j=d,N=g;else{const W=s+g,M=o/W;y=h,C=s*M,N=g*M,j=N*f,j>t&&(j=t,N=j/f)}const k=0,O=t/2,_=(t-j)/2,V=J(n,[{x:k,y:0,width:y,height:C,orientation:"wide"},{x:O,y:0,width:y,height:C,orientation:"wide"},{x:_,y:C,width:j,height:N,orientation:"wide"}]),$=y*C*2+j*N,P=$/(t*o)*100;return{videos:V,totalArea:$,efficiency:P}}if(e.landscape===3){const f=I.landscape,h=t/(f*1.5),s=Math.min(o,h),l=s/2,g=s,d=l*f,y=g*f,C=(o-s)/2,j=[{x:0,y:C,width:d,height:l,orientation:"landscape"},{x:0,y:C+l,width:d,height:l,orientation:"landscape"},{x:d,y:C,width:y,height:g,orientation:"landscape"}],N=J(n,j),k=d*s+y*s,O=k/(t*o)*100;return{videos:N,totalArea:k,efficiency:O}}const i=[];if(e.landscape>0)for(let f=0;f<e.landscape;f++)i.push("landscape");if(e.wide>0)for(let f=0;f<e.wide;f++)i.push("wide");const c=i[0]||n[0].orientation,a=i[1]||n[1].orientation,m=i[2]||n[2].orientation,w=I[c],u=I[a],p=I[m],R=[()=>{const f=t*.6,h=t*.4,s=f/w,l=h/u,g=h/p,d=l+g;return s<=o&&d<=o?{positions:[{x:0,y:(o-s)/2,width:f,height:s,orientation:c},{x:f,y:0,width:h,height:l,orientation:a},{x:f,y:l,width:h,height:g,orientation:m}],totalArea:f*s+h*l+h*g}:null},()=>{const f=o*.5,h=o*.5,s=f*w,l=f*u,g=h*p;return s+l<=t&&g<=t?{positions:[{x:0,y:0,width:s,height:f,orientation:c},{x:s,y:0,width:l,height:f,orientation:a},{x:(t-g)/2,y:f,width:g,height:h,orientation:m}],totalArea:s*f+l*f+g*h}:null},()=>{const f=t/3,h=f/w,s=f/u,l=f/p;return Math.max(h,s,l)<=o?{positions:[{x:0,y:(o-h)/2,width:f,height:h,orientation:c},{x:f,y:(o-s)/2,width:f,height:s,orientation:a},{x:f*2,y:(o-l)/2,width:f,height:l,orientation:m}],totalArea:f*h+f*s+f*l}:null}];let b=null,S=0;for(const f of R){const h=f();h&&h.totalArea>S&&(S=h.totalArea,b=h)}if(!b){const f=t/3,h=Math.min(f/w,o),s=Math.min(f/u,o),l=Math.min(f/p,o);b={positions:[{x:0,y:(o-h)/2,width:f,height:h,orientation:c},{x:f,y:(o-s)/2,width:f,height:s,orientation:a},{x:f*2,y:(o-l)/2,width:f,height:l,orientation:m}],totalArea:f*h+f*s+f*l}}const E=J(n,b.positions),x=b.totalArea/(t*o)*100;return{videos:E,totalArea:b.totalArea,efficiency:x}}function qn(e,n,t,o){if(e.portrait>0)return We(e,n,t,o);const i=[];if(e.landscape>0)for(let s=0;s<e.landscape;s++)i.push("landscape");if(e.wide>0)for(let s=0;s<e.wide;s++)i.push("wide");const c=i[0]||n[0].orientation,a=i[1]||n[1].orientation,m=i[2]||n[2].orientation,w=i[3]||n[3].orientation,u=I[c],p=I[a],R=I[m],b=I[w],S=[()=>{const s=t/2,l=o/2,g=Math.min(s,l*u),d=g/u,y=Math.min(s,l*p),C=y/p,j=Math.min(s,l*R),N=j/R,k=Math.min(s,l*b),O=k/b;return{positions:[{x:(s-g)/2,y:(l-d)/2,width:g,height:d,orientation:c},{x:s+(s-y)/2,y:(l-C)/2,width:y,height:C,orientation:a},{x:(s-j)/2,y:l+(l-N)/2,width:j,height:N,orientation:m},{x:s+(s-k)/2,y:l+(l-O)/2,width:k,height:O,orientation:w}],totalArea:g*d+y*C+j*N+k*O}},()=>{const s=t*.6,l=t*.4,g=s/u,d=o/3,y=Math.min(l,d*p),C=y/p,j=Math.min(l,d*R),N=j/R,k=Math.min(l,d*b),O=k/b;return g<=o?{positions:[{x:0,y:(o-g)/2,width:s,height:g,orientation:c},{x:s,y:0,width:y,height:C,orientation:a},{x:s,y:d,width:j,height:N,orientation:m},{x:s,y:d*2,width:k,height:O,orientation:w}],totalArea:s*g+y*C+j*N+k*O}:null},()=>{const s=t/4,l=s/u,g=s/p,d=s/R,y=s/b;return Math.max(l,g,d,y)<=o?{positions:[{x:0,y:(o-l)/2,width:s,height:l,orientation:c},{x:s,y:(o-g)/2,width:s,height:g,orientation:a},{x:s*2,y:(o-d)/2,width:s,height:d,orientation:m},{x:s*3,y:(o-y)/2,width:s,height:y,orientation:w}],totalArea:s*l+s*g+s*d+s*y}:null}];let E=null,x=0;for(const s of S){const l=s();l&&l.totalArea>x&&(x=l.totalArea,E=l)}if(!E){const s=t/2,l=o/2,g=Math.min(l,s/u),d=Math.min(l,s/p),y=Math.min(l,s/R),C=Math.min(l,s/b);E={positions:[{x:(s-s)/2,y:(l-g)/2,width:s,height:g,orientation:c},{x:s+(s-s)/2,y:(l-d)/2,width:s,height:d,orientation:a},{x:(s-s)/2,y:l+(l-y)/2,width:s,height:y,orientation:m},{x:s+(s-s)/2,y:l+(l-C)/2,width:s,height:C,orientation:w}],totalArea:s*g+s*d+s*y+s*C}}const f=J(n,E.positions),h=E.totalArea/(t*o)*100;return{videos:f,totalArea:E.totalArea,efficiency:h}}const Ke=({tokensLoading:e,tokensError:n,refreshTokens:t})=>r.jsx("div",{className:"token-error",children:e?r.jsxs(r.Fragment,{children:[r.jsx(z,{path:ct,size:"48px",color:"#ffffff",className:"loading-spinner"}),r.jsx("div",{children:"Lade Token..."})]}):r.jsxs(r.Fragment,{children:[r.jsx("div",{children:n||"Kamera-Token nicht verfügbar"}),r.jsx("button",{onClick:o=>{o.stopPropagation(),t()},children:"Token neu laden"})]})}),Jn=({cameras:e,accessTokens:n,tokensLoading:t,tokensError:o,refreshTokens:i,showDoorCams:c,cameraImgRefs:a,openDoor:m,config:w})=>{if(e.length===0)return null;const u=e.map(x=>({orientation:x.orientation||"landscape"})),p=window.innerWidth,R=window.innerHeight-10,b=xt(u,p,R),S={portrait:e.filter(x=>(x.orientation||"landscape")==="portrait"),landscape:e.filter(x=>(x.orientation||"landscape")==="landscape"),wide:e.filter(x=>x.orientation==="wide")},E={portrait:0,landscape:0,wide:0};return b.videos.map((x,f)=>{const h=x.orientation,s=E[h],l=S[h][s];if(!l)return null;E[h]++;const g=n[l.entity_id]||null,d=!!g,y=Gn(l.entity_id,g,w),C=`${h}-${s}-${f}`,j={left:`${x.x}px`,top:`${x.y}px`,width:`${x.width}px`,height:`${x.height}px`};return!y&&!d?r.jsx("div",{className:"video-container",style:j,children:r.jsx(Ke,{tokensLoading:t,tokensError:o,refreshTokens:i})},C):y?r.jsxs("div",{className:"video-container",style:j,children:[d&&c&&r.jsx("img",{ref:N=>{const k=`${l.entity_id}-${f}`;N?a.current.set(k,N):a.current.delete(k)},src:y,className:h,alt:"Camera stream",crossOrigin:"anonymous"},`${l.entity_id}-${f}`),!d&&r.jsx(Ke,{tokensLoading:t,tokensError:o,refreshTokens:i}),r.jsx("div",{className:"video-overlay",onClick:()=>m()})]},C):null})},Xn=v.div`
    @keyframes fadeOut {
        from {
            opacity: 1;
        }
...
`,Qn=()=>{const e=U(),n=e.ENABLE_DOORBELL||!1,t=e.DOORBELL_CAMERAS||[],[o,i]=A.useState(!1),[c]=Bn(),[a,m]=A.useState(void 0),[w,u]=A.useState(100),[p,R]=A.useState("0"),b=A.useMemo(()=>t.map(_=>_.entity_id).filter(Boolean),[t]),[S,E]=A.useState({}),[x,f]=A.useState(!1),[h,s]=A.useState(null),l=A.useRef(e);A.useEffect(()=>{l.current=e},[e]);const g=A.useRef(null);A.useEffect(()=>{if(o&&b.length>0){const _=new AbortController;return f(!0),s(null),He(b,l.current,_.signal).then(({tokens:D,error:V})=>{_.signal.aborted||(E(D),s(V),f(!1))}).catch(D=>{_.signal.aborted||(L.error("Failed to fetch camera tokens:",D),s(Z(D)),f(!1))}),()=>{_.abort()}}else o||(E({}),s(null),g.current?.abort())},[o,b.join(",")]);const d=A.useCallback(async()=>{if(b.length===0)return;g.current?.abort();const _=new AbortController;g.current=_,f(!0),s(null);try{const{tokens:D,error:V}=await He(b,l.current,_.signal);_.signal.aborted||(E(D),s(V))}catch(D){_.signal.aborted||(L.error("Failed to refresh camera tokens:",D),s(Z(D)))}finally{_.signal.aborted||f(!1)}},[b]),{isConnected:y}=Me(),C=A.useRef(!1);A.useEffect(()=>{y?C.current&&(C.current=!1,o&&b.length>0&&d()):C.current=!0},[y,o,b,d]),A.useEffect(()=>{if(!o||b.length===0)return;const _=setInterval(()=>{d()},pn);return()=>clearInterval(_)},[o,b,d]);const j=A.useRef(new Map);A.useEffect(()=>{o||(j.current.forEach(_=>{_&&_.src&&(_.src="")}),j.current.clear())},[o]),A.useEffect(()=>{if(c==="off"&&o){const _=window.setTimeout(()=>{i(!1),m(void 0)},Fe);return m(_),R(Fe+"ms"),u(0),()=>{_&&window.clearTimeout(_)}}else c==="on"&&(R(0),u(100),i(!0))},[c,o]),A.useEffect(()=>{c==="on"&&a!==void 0&&(window.clearTimeout(a),R(0),u(100),m(void 0))},[a,c]);const[N,k]=A.useState(null),O=()=>{N===null?k("confirm"):N==="confirm"&&(k("opening"),Vn(e),setTimeout(()=>k(null),2e3))};return A.useEffect(()=>{if(N==="confirm"){const _=setTimeout(()=>{k(null)},3e3);return()=>{clearTimeout(_)}}},[N]),A.useEffect(()=>{o||k(null)},[o]),n?r.jsxs(r.Fragment,{children:[r.jsx("button",{onClick:()=>i(_=>!_),children:"CCTV"}),r.jsx(he,{visible:o,onClick:O,onClose:()=>{i(!1),k(null)},fullsize:!0,children:r.jsxs(Xn,{onClick:O,children:[r.jsx(yt,{completed:w,height:10,bgColor:a===void 0?"none":"#c0bfbf",isLabelVisible:!1,baseBgColor:"",transitionDuration:p,transitionTimingFunction:"linear"}),r.jsx("div",{className:"grid",children:r.jsx(Jn,{cameras:t,accessTokens:S,tokensLoading:x,tokensError:h,refreshTokens:d,showDoorCams:o,cameraImgRefs:j,openDoor:O,config:e})}),N==="confirm"&&r.jsx("div",{className:"open-door confirm",children:"Haustür öffnen?"}),N==="opening"&&r.jsx("div",{className:"open-door opening",children:"Öffne die Tür!"})]})})]}):null},Zn=v.div`
  display: flex;
...
`,go=()=>{const[e,n]=A.useState(void 0),[t,o]=lo(e),{nextWeek:i,previousWeek:c,startWeekWithToday:a}=fo(n);A.useEffect(()=>{e===void 0&&a()},[]);const m=ho({onSwipedLeft:()=>i(),onSwipedRight:()=>c()}),w=T.useMemo(()=>({weekday:"short",month:"numeric",day:"numeric"}),[]),u=T.useMemo(()=>t.slice(0,7),[t]);return r.jsxs(po,{...m,children:[r.jsx(to,{nextWeek:i,previousWeek:c,startWeekWithToday:a}),r.jsxs("div",{className:"schedule",children:[u.map((p,R)=>r.jsx("div",{className:Y({weekend:je(p.date),today:Ne(p.date)},"caption"),children:r.jsx("h2",{children:p.date.toLocaleString(w)})},R)),u.map((p,R)=>r.jsx("div",{className:Y("allDayRow",{weekend:je(p.date),today:Ne(p.date)}),children:p.allDay.map((b,S)=>r.jsx("div",{className:"allDayEvent",children:b.summary},S))},R)),u.map((p,R)=>r.jsx("div",{className:Y("eventRow",{weekend:je(p.date),today:Ne(p.date)}),children:p.events.map((b,S)=>r.jsxs("div",{className:"event",children:[r.jsx("div",{children:b.summary}),r.jsxs("h3",{children:[b.icon&&r.jsx(z,{path:b.icon,size:"1rem",color:"#ffffff"}),Xe(b.start.dateTime)," - ",Xe(b.end.dateTime)]})]},S))},R))]}),t.length===0&&r.jsx("div",{className:"loading",children:o!==!1?r.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[r.jsx("h3",{children:"Fehler beim Laden der Kalenderdaten"}),r.jsx("div",{children:o instanceof Error?o.message:String(o)})]}):r.jsx(at,{visible:!0,height:"80",width:"80",color:"#c1c1c1",radius:"9",ariaLabel:"three-dots-loading",wrapperStyle:{},wrapperClass:""})}),o!==!1&&t.length>0&&r.jsx("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center",marginTop:"1rem"},children:r.jsxs("div",{children:["Warnung: ",o instanceof Error?o.message:String(o)]})})]})},mo=v.div`
...
`,tt=T.memo(({line:e,direction:n,realtimeOffset:t})=>r.jsxs("div",{className:"departure",children:[r.jsx("div",{children:r.jsx("img",{src:`https://cloud.geofox.de/icon/linename?name=${e}&outlined=true&fileFormat=SVG&height=14&appearance=COLOURED`,alt:`Linie ${e}`})}),r.jsx("div",{children:t===0?"Jetzt":r.jsxs(r.Fragment,{children:["in ",t," '"]})})]})),Oo=()=>{const n=U().ENABLE_HVV||!1,[t,o]=ko(be.departureList);return n?r.jsx(_o,{children:o!==!1?r.jsxs("div",{style:{padding:"1rem",color:"#f85a5a",textAlign:"center"},children:[r.jsx("h3",{children:"Fehler!"}),r.jsx("div",{children:o instanceof Error?o.message:String(o)})]}):r.jsxs(r.Fragment,{children:[r.jsx("h3",{children:"→ Wandsbek"}),t.to?.map((i,c)=>r.jsx(tt,{line:i.line,direction:i.direction,realtimeOffset:i.realtimeOffset},c)),r.jsx("h3",{children:"→ Stadtauswärts"}),t.from?.map((i,c)=>r.jsx(tt,{line:i.line,direction:i.direction,realtimeOffset:i.realtimeOffset},c))]})}):null},Do=T.memo(Oo),vo=()=>{const e=U(),n=e.ENABLE_EV||!1,t=e.ENTITY_PRECLIMATE_STATUS||"",o=e.ENTITY_CHARGING_STATE||"",i=e.ENTITY_STATE_OF_CHARGE||"",c=n&&(t||o||i),[a,m,w]=se({entityId:t,enabled:c&&!!t,config:e,initialState:"off"}),{error:u}=ue({entityId:t,enabled:c&&!!t,onStateUpdate:w,logPrefix:"EV preclimate",wsOptions:{checkBackendConnection:!1,reconnectStrategy:"exponential",maxReconnectAttempts:5,reconnectDelay:1e3}}),[p,R,b]=se({entityId:o,enabled:c&&!!o,config:e,initialState:"off"}),{error:S}=ue({entityId:o,enabled:c&&!!o,onStateUpdate:b,logPrefix:"EV charging",wsOptions:{checkBackendConnection:!1,reconnectStrategy:"exponential",maxReconnectAttempts:5,reconnectDelay:1e3}}),[E,x,f]=se({entityId:i,enabled:c&&!!i,config:e,initialState:"0"}),{error:h}=ue({entityId:i,enabled:c&&!!i,onStateUpdate:f,logPrefix:"EV SoC",wsOptions:{checkBackendConnection:!1,reconnectStrategy:"exponential",maxReconnectAttempts:5,reconnectDelay:1e3}});return[A.useMemo(()=>({preclimateStatus:a==="on",chargingState:p==="on",stateOfCharge:parseFloat(E)||0}),[a,p,E]),m||u||R||S||x||h||!1]},Io=e=>{const n=e?.ENTITY_PRECLIMATE_START||"";n&&B.post(H("/api/services/button/press",e),{entity_id:n}).catch(t=>{L.error("Failed to start preclimate:",t)})},$o=e=>{const n=e?.ENTITY_PRECLIMATE_STOP||"";n&&B.post(H("/api/services/button/press",e),{entity_id:n}).catch(t=>{L.error("Failed to stop preclimate:",t)})},Mo=({preclimateStatus:e,error:n,onStart:t,onStop:o})=>{const[i,c]=T.useState(!1),[a,m]=T.useState(null),[w,u]=T.useState(!1),[p,R]=T.useState(!1),[b,S]=T.useState(0),E=T.useRef(null),x=T.useRef(null),f=T.useRef(e),h=T.useRef(null);T.useEffect(()=>{f.current!==e&&(i&&h.current!==null&&e===(a==="start")&&(S(a==="start"?360:0),R(!0),setTimeout(()=>{c(!1),m(null),R(!1),S(0),h.current=null,u(!1)},300),E.current&&(clearTimeout(E.current),E.current=null)),f.current=e)},[e,i,a]),T.useEffect(()=>{if(!i||p){x.current&&(cancelAnimationFrame(x.current),x.current=null);return}const l=h.current||Date.now(),g=a==="stop",d=()=>{const y=Date.now()-l,C=Math.min(y/gn,1);S(g?360*(1-C):360*C),C<1&&!p&&(x.current=requestAnimationFrame(d))};return x.current=requestAnimationFrame(d),()=>{x.current&&(cancelAnimationFrame(x.current),x.current=null)}},[i,p,a]),T.useEffect(()=>()=>{E.current&&clearTimeout(E.current),x.current&&cancelAnimationFrame(x.current)},[]);const s=T.useCallback(()=>{if(n!==!1||i)return;const l=!e,g=l?"start":"stop";c(!0),m(g),R(!1),u(!1),S(0),h.current=Date.now(),f.current=e,l?t():o(),E.current=setTimeout(()=>{u(!0),setTimeout(()=>{c(!1),m(null),R(!1),S(0),u(!1),h.current=null},500)},mn)},[e,n,i,t,o]);return{isAnimating:i,animationDirection:a,shouldShake:w,isComplete:p,progressAngle:b,handleToggle:s}},Wo=v.div`
  padding-bottom: 12px;
...
`,ve=e=>{const n={unknown:{label:"In Bewegung oder halb-offen",icon:en},open:{label:"Offen",icon:Zt},closed:{label:"Geschlossen",icon:Qt},opening:{label:"Öffnet",icon:Xt},closing:{label:"Schließt",icon:Jt}};return n[e]||L.warn("Garage door state is not recognized:",e,"Available states: unknown, open, closed, opening, closing"),n[e]||{label:"Unavailable",icon:tn}},Ko=({garageDoor:e,animate:n=!1})=>r.jsxs(Et,{className:Y({animate:n}),children:[r.jsx(z,{path:ve(e).icon,size:"2rem",color:"#ffffff"}),r.jsx("span",{children:ve(e).label})]}),qo=e=>Dt.promise(e,{pending:"Garagentor ist in Bewegung …",success:{render({data:n}){return ve(n).label}},error:"Nope"},{position:"bottom-center",autoClose:5e3,hideProgressBar:!1,closeOnClick:!1,pauseOnHover:!1,draggable:!1,progress:void 0,theme:"dark",transition:void 0}),Jo=()=>{const e=U(),n=e.ENABLE_GARAGE||!1,[t,o]=Fo(),[i,c]=A.useState(void 0),[a,m]=A.useState(!1),[w,u]=A.useState(!1);A.useEffect(()=>{if(t==="unknown"||t==="opening"||t==="closing"){if(!i){const E=new Promise(x=>{c({resolve:x})});qo(E)}}else i&&(i.resolve(t),c(void 0))},[t]);const p=fe("g");A.useEffect(()=>{p&&o===!1&&Go(m,e)},[p,o,e]);const R=T.useCallback(S=>{if(o===!1)switch(u(!1),S){case"open":zo(m,e);break;case"close":Yo(m,e);break}},[m,o,e]),b=T.useCallback(()=>{o===!1&&u(!0)},[o]);return n?r.jsxs(Ho,{className:Y({disabled:o!==!1}),children:[r.jsx("h2",{children:"Garage"}),r.jsx("div",{className:"status",onClick:b,children:o!==!1?r.jsxs(Et,{children:[r.jsx(z,{path:Ie,size:"2rem",color:"#f85a5a"}),r.jsx("span",{children:"Fehler"})]}):r.jsx(Ko,{garageDoor:t,animate:a})}),r.jsx(he,{visible:w&&o===!1,onClick:()=>u(!1),children:r.jsxs("div",{className:"controls",children:[r.jsx("h2",{children:"Garagentor"}),r.jsx("div",{onClick:()=>R("open"),children:"Öffnen"}),r.jsx("div",{onClick:()=>R("close"),children:"Schließen"})]})})]}):null},Xo=T.memo(Jo),Qo=({entityIds:e,enabled:n,onStateUpdate:t,logPrefix:o,wsOptions:i={}})=>{const{error:c}=mt({enabled:n&&e.length>0,logPrefix:o,...i,onReady:(a,m)=>(e.forEach(w=>{const u=p=>{p.state!==void 0&&t(w,p.state)};m.current.set(w,u),a.readyState===WebSocket.OPEN&&a.send(JSON.stringify({type:"subscribe_entity",entity_id:w}))}),e.length>0&&L.debug(`Subscribed to ${o} state changes: ${e.join(", ")}`),()=>{e.forEach(w=>{m.current.delete(w),a.readyState===WebSocket.OPEN&&a.send(JSON.stringify({type:"unsubscribe_entity",entity_id:w}))})}),dependencies:[n,e.join(",")]});return{error:c}},q={done:{label:"Fertig",animate:!1,icon:on},off:{label:"Aus",animate:!1,icon:nn},standby:{label:"Standby",animate:!1,icon:Be},running:{label:"Läuft …",animate:!0,icon:Be}},Zo={off:0,standby:2,running:16,done:256},er=()=>{const e=U(),n=e.ENABLE_LAUNDRY||!1,t=e.LAUNDRY_MACHINES||[],o=Array.isArray(t)?t:[],i=A.useMemo(()=>o.filter(l=>l.entity_id).map(l=>l.entity_id),[o.map(l=>l.entity_id).join(",")]),[c,a]=A.useState({}),[m,w]=A.useState({}),u=A.useCallback((l,g)=>{a(d=>({...d,[l]:g}))},[]),{error:p}=Qo({entityIds:i,enabled:n&&i.length>0,onStateUpdate:u,logPrefix:"laundry"});A.useEffect(()=>{if(!n||i.length===0)return;const l=new Map;return i.forEach(g=>{const d=H(`/api/states/${g}`,e);if(!d)return;const y=new AbortController;l.set(g,y),B(d,{signal:y.signal}).then(C=>{a(j=>({...j,[g]:C.data.state})),w(j=>({...j,[g]:!1}))}).catch(C=>{y.signal.aborted||w(j=>({...j,[g]:Z(C)}))})}),()=>{l.forEach(g=>g.abort())}},[n,i.join(","),e]);const R=o.map(l=>({state:c[l.entity_id]||"off",error:m[l.entity_id]||p||!1,name:l.name})),[b,S]=A.useState(q.off),[E,x]=A.useState(!1),f=R.map(l=>l.state),h=R.map(l=>l.error);A.useEffect(()=>{const l=h.some(g=>g!==!1);x(l&&h.find(g=>g!==!1)||!1)},[h]),A.useEffect(()=>{const l=f.reduce((g,d)=>g+(Zo[d]||0),0);l===0?S(q.off):l<16?S(q.standby):l<256?S(q.running):l%256===0?S(q.done):l%256%16===0?S(q.running):l%256%2===0?S(q.done):S(q.running)},[f]);const s=R.map(l=>({label:l.name,state:l.state}));return[b,s,E]},tr=v.div`
  padding-bottom: 12px;
...
`,nr=()=>{const n=U().ENABLE_LAUNDRY||!1,[t,o,i]=er(),[c,a]=A.useState(!1),m=T.useCallback(()=>{i===!1&&a(!0)},[i]),w=T.useCallback(()=>a(!1),[]);return n?r.jsxs(tr,{className:Y({disabled:i!==!1}),children:[r.jsx("h2",{children:"Wäsche"}),r.jsx("div",{className:"status",onClick:m,children:i!==!1?r.jsxs(r.Fragment,{children:[r.jsx(z,{path:Ie,size:"2rem",color:"#f85a5a"}),r.jsx("span",{children:"Fehler"})]}):r.jsxs(r.Fragment,{children:[r.jsx("div",{className:Y({animate:t.animate}),children:r.jsx(z,{path:t.icon,size:"2rem",color:"#ffffff"})}),r.jsx("span",{children:t.label})]})}),r.jsx(he,{visible:c&&i===!1,onClick:w,children:r.jsxs("div",{className:"states",children:[r.jsx("h2",{children:"Wäsche"}),o.map((u,p)=>r.jsxs("div",{children:[r.jsx("div",{className:"subtitle",children:u.label}),r.jsx("div",{className:Y({animate:q[u.state].animate}),children:r.jsx(z,{path:q[u.state].icon,size:2})}),r.jsx("div",{children:q[u.state].label})]},p))]})})]}):null},or=T.memo(nr),rr=v.div`
  padding: 0 0 0 24px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
