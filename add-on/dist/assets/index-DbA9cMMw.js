...
`,Ut=(0,N.memo)(({nextWeek:e,previousWeek:t,startWeekWithToday:n})=>(0,I.jsxs)(Ht,{children:[(0,I.jsxs)(`div`,{className:`buttons`,children:[(0,I.jsx)(F,{path:pe,size:`32px`,color:`#ffffff`,onClick:t}),(0,I.jsx)(F,{path:ne,size:`32px`,color:`#ffffff`,onClick:e}),(0,I.jsx)(`button`,{onClick:n,children:`Today`}),(0,I.jsx)(Vt,{})]}),(0,I.jsx)(xt,{}),(0,I.jsx)(F,{path:ge,size:`32px`,color:`#ffffff`,className:O(`indicator`)})]})),Wt=5e3,X=class extends N.Component{constructor(e){super(e),this.state={hasError:!1},this.reloadTimerId=null}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(e,t){let n=e?.toString()||`Unknown error`,r=this.props.label;z.error(`ErrorBoundary caught an error${r?` (${r})`:``}: ${n}`,{boundaryLabel:r,errorName:e?.name,errorMessage:n,errorStack:e?.stack||``,componentStack:t?.componentStack||``});let i=this.props.autoReload===!0,a=i?`${r?`${r}: `:``}Ein Fehler ist aufgetreten — die App lädt sich gleich neu …`:`${r?`${r}: `:``}Bereich konnte nicht geladen werden`;f.error(a,{duration:Wt}),i&&(this.reloadTimerId=window.setTimeout(()=>{window.location.reload()},Wt))}componentWillUnmount(){this.reloadTimerId&&=(window.clearTimeout(this.reloadTimerId),null)}render(){return this.state.hasError?null:this.props.children}},Gt=e(_e(),1),Kt=6e4,qt=(e=Kt,t=void 0)=>{let[n,r]=N.useState(!0);return N.useEffect(()=>{let t=setInterval(()=>{r(e=>!e)},e);return()=>{clearInterval(t)}},[e,t]),n},Jt={mdiDelete:se,mdiCake:oe},Yt=e=>{if(!(!e||typeof e!=`string`))return Jt[e.startsWith(`mdi`)?e:`mdi${e.charAt(0).toUpperCase()+e.slice(1)}`]||void 0},Xt=(e,t,n,r,i,a)=>M(i(e.name,{start:t.toISO(),end:n.toISO()}),{timeout:65e3,signal:a}).then(n=>{!n.data||!Array.isArray(n.data)||n.data.forEach(n=>{let i=`dateTime`in n.start?D.fromISO(n.start.dateTime):D.fromSQL(n.start.date),a;a=`dateTime`in n.end?Math.floor(D.fromISO(n.end.dateTime).diff(t,`days`).as(`days`)):Math.floor(D.fromSQL(n.end.date).diff(t,`days`).as(`days`))-1;let o=Math.floor(i.diff(t,`days`).as(`days`));a>=r.length&&(a=r.length-1);let s=`dateTime`in n.start?`events`:`allDay`;if(o>=0&&o<r.length)for(let t=o;t<=a;t++)r[t][s]=[...r[t][s],{...n,icon:e.icon}]})}).catch(e=>{if(!(M.isCancel(e)||e.name===`AbortError`||e.code===`ERR_CANCELED`))throw e}),Zt=new Map,Qt=300*1e3,$t=e=>e.toISODate(),en=(e,t,n,r,i,a,o,s,c)=>{let l=[0,1,2,3,4,5].map(t=>e.plus({days:t}).startOf(`day`));l[6]=e.plus({days:6}).endOf(`day`);let u=$t(e),d=Zt.get(u);if(d&&Date.now()-d.timestamp<Qt){c.current&&n(d.data);return}let f=l.map(e=>({date:e,allDay:[],events:[]}));if(!o||o.length===0){z.warn(`loadAll: No calendars configured, skipping fetch`,{calendars:o}),c.current&&(n(f),r(!1));return}z.debug(`loadAll: Starting calendar fetch`,{calendarsCount:o.length,calendars:o.map(e=>e.name),startDate:e.toISO(),endDate:l[6].toISO()});let p=new AbortController;i.current&&i.current.abort(),i.current=p;try{c.current&&r(!0);let e=o.map(e=>Xt(e,l[0],l[6],f,s,p.signal));Promise.all(e).then(()=>{c.current&&!p.signal.aborted&&(Zt.set(u,{data:f,timestamp:Date.now()}),n(f),a(!1))}).catch(e=>{c.current&&!p.signal.aborted&&a(G(e))}).finally(()=>{c.current&&!p.signal.aborted&&r(!1)})}catch(e){c.current&&!p.signal.aborted&&(a(G(e)),r(!1))}},tn=[],nn=e=>{let t=V(),n=t.CALENDARS||[];N.useEffect(()=>{z.debug(`useCalendarData: config changed`,{hasCALENDARS:`CALENDARS`in t,CALENDARS:t.CALENDARS,CALENDARSCount:Array.isArray(t.CALENDARS)?t.CALENDARS.length:`not array`,configKeys:Object.keys(t)})},[t]);let r=N.useMemo(()=>{let e=n.map(e=>({name:e.name,icon:Yt(e.icon)}));return z.debug(`Processing calendars from config (memo update):`,{CALENDARS:n,count:n.length,processedCount:e.length,processed:e.map(e=>e.name)}),e},[n]);N.useEffect(()=>{z.debug(`CALENDARS array changed:`,{CALENDARS:n,count:n.length,calendarsMemoCount:r.length})},[n,r.length]);let i=N.useCallback(e=>{let n=K(`/api/calendars/${e}`,t);return z.debug(`Building calendar URL for ${e}:`,n),n},[t]),a=N.useCallback((e,t)=>{let n=`${i(e)}?${Gt.default.stringify(t)}`;return z.debug(`Full calendar URL for ${e}:`,n),n},[i]),[o,s]=N.useState(tn),[c,l]=N.useState(!1),[u,d]=N.useState(!1),[f,p]=N.useState(null),m=(0,N.useRef)(null),h=(0,N.useRef)(!0);return qt(6e4,`Calendar`),N.useEffect(()=>(h.current=!0,z.debug(`useCalendarData effect triggered:`,{startDate:e?.toISO(),calendarsCount:r.length,calendars:r.map(e=>e.name),hasStartDate:e!==void 0,hasCalendars:r.length>0}),e!==void 0&&r.length>0?((f===null||!f.equals(e))&&(s(tn),p(e)),z.debug(`useCalendarData: Calling loadAll`,{startDate:e.toISO(),calendarsCount:r.length}),en(e,o,s,l,m,d,r,a,h)):(e===void 0&&z.debug(`useCalendarData: startDate is undefined, skipping fetch`),r.length===0&&z.debug(`useCalendarData: No calendars configured yet, skipping fetch`)),()=>{h.current=!1,m.current&&m.current.abort()}),[e,r,a]),[o,u]};function rn(e){let[t,n]=N.useState(!1);function r({key:t}){t===e&&n(!0)}let i=({key:t})=>{t===e&&n(!1)};return N.useEffect(()=>(window.addEventListener(`keydown`,r),window.addEventListener(`keyup`,i),()=>{window.removeEventListener(`keydown`,r),window.removeEventListener(`keyup`,i)}),[e]),t}var an=()=>{let e=new Date,t=(e.getDay()+6)%7,n=new Date(e.setDate(e.getDate()-t));return D.fromJSDate(n)},on=e=>{let t=()=>e(e=>e.plus({days:7})),n=rn(`ArrowRight`);N.useEffect(()=>{n&&t()},[n]);let r=()=>e(e=>e.minus({days:7})),i=rn(`ArrowLeft`);N.useEffect(()=>{i&&r()},[i]);let a=()=>e(an()),o=rn(`t`);return N.useEffect(()=>{o&&a()},[o]),{nextWeek:t,previousWeek:r,startWeekWithToday:a}},sn=e=>{let[t,n]=(0,N.useState)(0),[r,i]=(0,N.useState)(0);return{onTouchStart:e=>{i(0),n(e.targetTouches[0].clientX)},onTouchMove:e=>i(e.targetTouches[0].clientX),onTouchEnd:()=>{if(!t||!r)return;let n=t-r,i=n>50,a=n<-50;i&&e.onSwipedLeft(),a&&e.onSwipedRight()}}},cn=e=>D.fromISO(e).toLocaleString(D.TIME_24_SIMPLE),ln=e=>e.toFormat(`c`)>=6,un=e=>e.hasSame(D.now(),`day`),dn=s.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  overflow: hidden;
...
`,fn=()=>{let[e,t]=N.useState(void 0),[n,r]=nn(e),{nextWeek:i,previousWeek:o,startWeekWithToday:s}=on(t);N.useEffect(()=>{e===void 0&&s()},[]);let c=sn({onSwipedLeft:()=>i(),onSwipedRight:()=>o()}),l=(0,N.useMemo)(()=>({weekday:`short`,month:`numeric`,day:`numeric`}),[]),u=(0,N.useMemo)(()=>n.slice(0,7),[n]);return(0,I.jsxs)(dn,{...c,children:[(0,I.jsx)(X,{label:`Header`,children:(0,I.jsx)(Ut,{nextWeek:i,previousWeek:o,startWeekWithToday:s})}),(0,I.jsxs)(`div`,{className:`schedule`,children:[u.map((e,t)=>(0,I.jsx)(`div`,{className:O({weekend:ln(e.date),today:un(e.date)},`caption`),children:(0,I.jsx)(`h2`,{children:e.date.toLocaleString(l)})},t)),u.map((e,t)=>(0,I.jsx)(`div`,{className:O(`allDayRow`,{weekend:ln(e.date),today:un(e.date)}),children:e.allDay.map((e,t)=>(0,I.jsx)(`div`,{className:`allDayEvent`,children:e.summary},t))},t)),u.map((e,t)=>(0,I.jsx)(`div`,{className:O(`eventRow`,{weekend:ln(e.date),today:un(e.date)}),children:e.events.map((e,t)=>(0,I.jsxs)(`div`,{className:`event`,children:[(0,I.jsx)(`div`,{children:e.summary}),(0,I.jsxs)(`h3`,{children:[e.icon&&(0,I.jsx)(F,{path:e.icon,size:`1rem`,color:`#ffffff`}),cn(e.start.dateTime),` - `,cn(e.end.dateTime)]})]},t))},t))]}),n.length===0&&(0,I.jsx)(`div`,{className:`loading`,children:r===!1?(0,I.jsx)(a,{visible:!0,height:`80`,width:`80`,color:`#c1c1c1`,radius:`9`,ariaLabel:`three-dots-loading`,wrapperStyle:{},wrapperClass:``}):(0,I.jsxs)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`},children:[(0,I.jsx)(`h3`,{children:`Fehler beim Laden der Kalenderdaten`}),(0,I.jsx)(`div`,{children:r instanceof Error?r.message:String(r)})]})}),r!==!1&&n.length>0&&(0,I.jsx)(`div`,{style:{padding:`1rem`,color:`#f85a5a`,textAlign:`center`,marginTop:`1rem`},children:(0,I.jsxs)(`div`,{children:[`Warnung: `,r instanceof Error?r.message:String(r)]})})]})},pn={"clear-day":{icon:_,label:`Klar`,color:`#eeeef5`},"clear-night":{icon:c,label:`Klar`,color:`#eeeef5`},rain:{icon:S,label:`Regen`,color:`#80a5d6`},snow:{icon:u,label:`Schnee`,color:`#8c82ce`},sleet:{icon:l,label:`Graupel`,color:`#aba4db`},wind:{icon:v,label:`Stürmisch`,color:`#9fb6d6`},fog:{icon:b,label:`Neblig`,color:`#d5dae2`},cloudy:{icon:p,label:`Bewölkt`,color:`#b6bfcb`},"partly-cloudy-day":{icon:o,label:`Teils bewölkt`,color:`#d5dae2`},"partly-cloudy-night":{icon:m,label:`Teils bewölkt`,color:`#d5dae2`}},mn=e=>{let[t,n]=N.useState([]),[r,i]=N.useState(!1),a=qt(6e4*10,`Weather`),o=V(),s=o.ENABLE_WEATHER||!1,c=o.WEATHER_LATITUDE,l=o.WEATHER_LONGITUDE,u=s&&c&&l,d=()=>`.${`/forecast/${c},${l}?units=si&exclude=minutely`}`;return N.useEffect(()=>{if(!u){e&&e(!1);return}let t=!0,r=new AbortController;return e&&e(!0),M(d(),{signal:r.signal}).then(e=>{t&&(n(e.data),i(!1))}).catch(e=>{t&&!r.signal.aborted&&i(G(e))}).finally(()=>{t&&e&&e(!1)}),()=>{t=!1,r.abort()}},[a,e,u,s,c,l]),[t,r]},hn=x(g),gn=s.div`
...
`,$n=(0,N.memo)(()=>{let e=V().ENABLE_LAUNDRY||!1,[t,n,r]=Zn(),[i,a]=N.useState(!1),o=(0,N.useCallback)(()=>{r===!1&&a(!0)},[r]),s=(0,N.useCallback)(()=>a(!1),[]);return e?(0,I.jsxs)(Qn,{className:O({disabled:r!==!1}),children:[(0,I.jsx)(`h2`,{children:`Wäsche`}),(0,I.jsx)(`div`,{className:`status`,onClick:o,children:r===!1?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(`div`,{className:O({animate:t.animate}),children:(0,I.jsx)(F,{path:t.icon,size:`2rem`,color:`#ffffff`})}),(0,I.jsx)(`span`,{children:t.label})]}):(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(F,{path:fe,size:`2rem`,color:`#f85a5a`}),(0,I.jsx)(`span`,{children:`Fehler`})]})}),(0,I.jsx)(xe,{visible:i&&r===!1,onClick:s,children:(0,I.jsxs)(`div`,{className:`states`,children:[(0,I.jsx)(`h2`,{children:`Wäsche`}),n.map((e,t)=>(0,I.jsxs)(`div`,{children:[(0,I.jsx)(`div`,{className:`subtitle`,children:e.label}),(0,I.jsx)(`div`,{className:O({animate:Z[e.state].animate}),children:(0,I.jsx)(F,{path:Z[e.state].icon,size:2})}),(0,I.jsx)(`div`,{children:Z[e.state].label})]},t))]})})]}):null}),er=s.div`
  padding: 0 0 0 24px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
`;function Mr(){kr();let e=Ye(),t=Xe(),n=Je(),[r]=N.useState(()=>{try{if(typeof window<`u`&&window.localStorage)return localStorage.getItem(Er)===`true`}catch{}return!1});return(0,I.jsxs)(jr,{$hasBanner:!n&&!r&&(e||t),children:[(0,I.jsx)(Ar,{}),(0,I.jsx)(Or,{}),(0,I.jsxs)(`div`,{className:`main`,children:[(0,I.jsx)(X,{autoReload:!0,label:`Kalender`,children:(0,I.jsx)(fn,{})}),(0,I.jsx)(X,{autoReload:!0,label:`Sidebar`,children:(0,I.jsx)(tr,{})})]}),(0,I.jsx)(h,{position:`bottom-center`,theme:`dark`,duration:5e3,closeButton:!0})]})}function Nr(){return(0,I.jsx)(X,{autoReload:!0,label:`App`,children:(0,I.jsxs)(w,{children:[(0,I.jsx)(t,{path:`/demo`,element:(0,I.jsx)(Tr,{})}),(0,I.jsx)(t,{path:`/tiling-demo`,element:(0,I.jsx)(Tr,{})}),(0,I.jsx)(t,{path:`*`,element:(0,I.jsx)(Mr,{})})]})})}ye.createRoot(document.getElementById(`root`)).render((0,I.jsx)(N.StrictMode,{children:(0,I.jsx)(X,{autoReload:!0,label:`Root`,children:(0,I.jsx)(qe,{children:(0,I.jsx)(dt,{children:(0,I.jsx)(r,{children:(0,I.jsx)(Nr,{})})})})})}));