...
`,L=({visible:n,children:e,onClick:i,fullsize:t=!1})=>r.jsxs(Ze,{className:j({visible:n}),onClick:i,children:[r.jsx("div",{className:"close",children:r.jsx(_,{path:Re,size:2,onClick:i})}),r.jsx("div",{className:j("content",{fullsize:t}),onClick:s=>s.stopPropagation(),children:e})]}),et={BASE_URL:"./",DEV:!1,MODE:"production",PROD:!0,SSR:!1},g=(n,e=void 0)=>{if(typeof window<"u"&&window.APP_CONFIG){if(window.APP_CONFIG[n]!==void 0){const t=window.APP_CONFIG[n];return t==="undefined"||t==="null"?e:t??e}return e}const i=et[`VITE_${n}`];return n==="HASS_ACCESS_TOKEN"&&i!==void 0&&!(typeof window<"u"&&window.location&&(window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1"))?e:i!==void 0?i:e},D=(n,e=!1)=>{const i=g(n,e);return typeof i=="boolean"?i:typeof i=="string"?i==="true"||i==="1"||i==="yes":!!i},k=g("HASS_HOST",""),S=g("HASS_ACCESS_TOKEN",""),tt=S&&typeof S=="string"&&S.trim()!==""&&S!=="undefined"&&S!=="null";tt?y.defaults.headers.common.Authorization=`Bearer ${S}`:delete y.defaults.headers.common.Authorization;const nt=D("ENABLE_WEATHER",!1),st=D("ENABLE_HVV",!1);D("ENABLE_TELEGRAM",!1);const rt=D("ENABLE_GARAGE",!1),it=D("ENABLE_LAUNDRY",!1),at=D("ENABLE_DOORBELL",!1),ot=D("ENABLE_EVERYDAY_CALENDAR",!1);D("ENABLE_PHYSICAL_BUTTONS",!1);const J=g("WEATHER_API_KEY"),fe=g("WEATHER_LATITUDE"),ue=g("WEATHER_LONGITUDE"),W=g("GEOFOX_SECRET"),Q=g("GEOFOX_USER");g("TELEGRAM_BOT_TOKEN");g("TELEGRAM_CHAT_ID");g("BUTTONS_WS_URL");const E=g("ENTITY_GARAGE_DOOR"),he=g("ENTITY_WASHING_MACHINE_NEW"),pe=g("ENTITY_WASHING_MACHINE_OLD"),me=g("ENTITY_DRYER"),A=g("ENTITY_DOORBELL"),ee=g("ENTITY_DOORBELL_BUTTON"),P=g("ENTITY_EVERYDAY_CALENDAR"),T=n=>{const e=k==="undefined"||k==="null"?"":k;return e?`${e}${n.startsWith("/")?n:`/${n}`}`:n.startsWith("/")?n:`/${n}`},b={log:(...n)=>{},error:(...n)=>{console.error(...n)},warn:(...n)=>{},debug:(...n)=>{}},N=P?T(`/api/states/${P}`):null,ct=()=>{const[n,e]=d.useState(null),i=ot&&P;return d.useEffect(()=>{!i||!N||y(N).then(t=>{t.data.attributes.store!==void 0?e(t.data.attributes.store):e([])}).catch(t=>{b.error("Failed to fetch everyday calendar state:",t),e([])})},[i,N]),n},lt=n=>{N&&y.post(N,{state:new Date,attributes:{store:n}})},te=w.div` 
...
`,Rt=()=>{const[n,e]=d.useState(void 0),i=Nt(n),{nextWeek:t,previousWeek:s,startWeekWithToday:a}=Lt(e);d.useEffect(()=>{a()},[]);const o=Ot({onSwipedLeft:()=>t(),onSwipedRight:()=>s()}),c=m.useMemo(()=>({weekday:"short",month:"numeric",day:"numeric"}),[]),f=m.useMemo(()=>i.slice(0,7),[i]);return r.jsxs(It,{...o,children:[r.jsx(vt,{nextWeek:t,previousWeek:s,startWeekWithToday:a}),r.jsxs("div",{className:"schedule",children:[f.map((l,u)=>r.jsx("div",{className:j({weekend:G(l.date),today:F(l.date)},"caption"),children:r.jsx("h2",{children:l.date.toLocaleString(c)})},u)),f.map((l,u)=>r.jsx("div",{className:j("allDayRow",{weekend:G(l.date),today:F(l.date)}),children:l.allDay.map((h,p)=>r.jsx("div",{className:"allDayEvent",children:h.summary},p))},u)),f.map((l,u)=>r.jsx("div",{className:j("eventRow",{weekend:G(l.date),today:F(l.date)}),children:l.events.map((h,p)=>r.jsxs("div",{className:"event",children:[r.jsx("div",{children:h.summary}),r.jsxs("h3",{children:[h.icon&&r.jsx(_,{path:h.icon,size:"1rem",color:"#ffffff"}),ie(h.start.dateTime)," - ",ie(h.end.dateTime)]})]},p))},u))]}),i.length===0&&r.jsx("div",{className:"loading",children:r.jsx(de,{visible:!0,height:"80",width:"80",color:"#c1c1c1",radius:"9",ariaLabel:"three-dots-loading",wrapperStyle:{},wrapperClass:""})})]})},M={"clear-day":{icon:Ce,label:"Klar",color:"#eeeef5"},"clear-night":{icon:De,label:"Klar",color:"#eeeef5"},rain:{icon:_e,label:"Regen",color:"#80a5d6"},snow:{icon:Te,label:"Schnee",color:"#8c82ce"},sleet:{icon:Se,label:"Graupel",color:"#aba4db"},wind:{icon:je,label:"Stürmisch",color:"#9fb6d6"},fog:{icon:ve,label:"Neblig",color:"#d5dae2"},cloudy:{icon:Ee,label:"Bewölkt",color:"#b6bfcb"},"partly-cloudy-day":{icon:be,label:"Teils bewölkt",color:"#d5dae2"},"partly-cloudy-night":{icon:we,label:"Teils bewölkt",color:"#d5dae2"}},Wt=()=>`./forecast/${J}/${fe},${ue}?&units=si&exclude=minutely`,Pt=n=>{const[e,i]=d.useState([]),t=X(6e4*10,"Weather"),s=nt&&J&&fe&&ue;return d.useEffect(()=>{s&&y(Wt()).then(a=>{i(a.data)}).catch(a=>{b.error("Could not load weather data",a)}).finally(()=>{})},[t,n,s]),e},Mt=Ae(Ne),Ht=w.div`
